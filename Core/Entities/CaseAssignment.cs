// The source file: CASE_ASSIGNMENT, ID: 371430922, model: 746.
using System;
...
/// <summary>
/// RESP: SRVPLAN
/// This documents the assignment of a case to an office service provider.
/// DATA MODEL ALERT!!!!
/// *	The relationship between CASE and CASE ASSIGNMENT is not drawn.
/// each CASE sometimes is assigned to one or more CASE ASSIGNMENT
/// each CASE ASSIGNMENT always assigns one CASE
/// *	The relationship between OFFICE SERVICE PROVIDER and CASE ASSSIGNMENT is 
/// not drawn.
/// each OFFICE SERVICER PROVIDER sometimes is assigned to one or more CASE 
/// ASSIGNMENT
/// each CASE ASSIGNMENT always assigns one OFFICE SERVICE PROVIDER
/// *	Both relationships should be added to the identifier.
/// </summary>
[Serializable]
public partial class CaseAssignment: View, ICloneable
{
  ...
  public CaseAssignment(CaseAssignment that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new CaseAssignment Clone() => new(this);
  ...
  public void Assign(CaseAssignment that)
  {
    base.Assign(that);
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 9, Type = MemberType.Char, Length = CasNo_MaxLength)]
  public string CasNo
  {
    get => casNo ?? "";
