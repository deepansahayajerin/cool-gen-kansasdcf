// The source file: CASH_RECEIPT_DELETE_REASON, ID: 371431476, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// The explanation for removing a cash receipt.
/// </summary>
[Serializable]
public partial class CashReceiptDeleteReason: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public CashReceiptDeleteReason()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public CashReceiptDeleteReason(CashReceiptDeleteReason that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new CashReceiptDeleteReason Clone() => new(this);
  ...
  public void Assign(CashReceiptDeleteReason that)
  {
    base.Assign(that);
