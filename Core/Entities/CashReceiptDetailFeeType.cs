// The source file: CASH_RECEIPT_DETAIL_FEE_TYPE, ID: 371431738, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// This entity contains all of the possible fee types that a cash receipt 
/// detail may have.  This was created primarily to support the multiple fees
/// that other states may assess to a collection.
/// </summary>
[Serializable]
public partial class CashReceiptDetailFeeType: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public CashReceiptDetailFeeType()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public CashReceiptDetailFeeType(CashReceiptDetailFeeType that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new CashReceiptDetailFeeType Clone() => new(this);
  ...
  public void Assign(CashReceiptDetailFeeType that)
  {
    base.Assign(that);
