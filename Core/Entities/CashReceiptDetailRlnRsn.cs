// The source file: CASH_RECEIPT_DETAIL_RLN_RSN, ID: 371431844, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// This entity contains all of the valid reasons why two cash receipt details 
/// would be related to each other.
/// </summary>
[Serializable]
public partial class CashReceiptDetailRlnRsn: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public CashReceiptDetailRlnRsn()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public CashReceiptDetailRlnRsn(CashReceiptDetailRlnRsn that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new CashReceiptDetailRlnRsn Clone() => new(this);
  ...
  public void Assign(CashReceiptDetailRlnRsn that)
  {
    base.Assign(that);
