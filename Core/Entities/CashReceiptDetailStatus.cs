// The source file: CASH_RECEIPT_DETAIL_STATUS, ID: 371431899, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// Defines the various states of the cash receipt detail.
/// Examples: Recorded, Pended, Released, Suspended, Refunded &amp; Distributed.
/// </summary>
[Serializable]
public partial class CashReceiptDetailStatus: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public CashReceiptDetailStatus()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public CashReceiptDetailStatus(CashReceiptDetailStatus that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new CashReceiptDetailStatus Clone() => new(this);
  ...
  public void Assign(CashReceiptDetailStatus that)
  {
    base.Assign(that);
  ...
  [Member(Index = 8, Type = MemberType.Char, Length = LastUpdateBy_MaxLength, Optional
    = true)]
