// The source file: CASH_RECEIPT_RLN_RSN, ID: 371431982, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// Contains the valid reasons why two occurrances of a cash receipt may be 
/// related together.
/// </summary>
[Serializable]
public partial class CashReceiptRlnRsn: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public CashReceiptRlnRsn()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public CashReceiptRlnRsn(CashReceiptRlnRsn that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new CashReceiptRlnRsn Clone() => new(this);
  ...
  public void Assign(CashReceiptRlnRsn that)
  {
    base.Assign(that);
