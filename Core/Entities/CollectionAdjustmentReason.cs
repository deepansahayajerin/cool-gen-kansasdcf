// The source file: COLLECTION_ADJUSTMENT_REASON, ID: 371432410, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// This represents the reason for a collection adjustment.
/// </summary>
[Serializable]
public partial class CollectionAdjustmentReason: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public CollectionAdjustmentReason()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public CollectionAdjustmentReason(CollectionAdjustmentReason that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new CollectionAdjustmentReason Clone() => new(this);
  ...
  public void Assign(CollectionAdjustmentReason that)
  {
    base.Assign(that);
