// The source file: CONTACT_ADDRESS, ID: 371432616, model: 746.
using System;
...
/// <summary>
/// RESP: OBLGESTB
/// Address of Contact. This entity was created from the original entity 
/// ADDRESS.
/// </summary>
[Serializable]
public partial class ContactAddress: View, ICloneable
{
  ...
  public ContactAddress(ContactAddress that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new ContactAddress Clone() => new(this);
  ...
  public void Assign(ContactAddress that)
  {
    base.Assign(that);
  ...
  /// The date the contact address was verified.
  /// </summary>
  ...
  /// the first line of postal address of a contact address.
  /// </summary>
  ...
  /// The second line of a postal address for a contact address.
  /// </summary>
  ...
  /// The community where the contact address is located.
  /// </summary>
  ...
  /// The politically autonomous or semi-autonomous region in which the contact 
  /// address is located.
  /// </summary>
  ...
  /// The administrative district in which the contact address is located.
  /// </summary>
  ...
  /// Identifying the area in which the contact foreign address is located.
  /// </summary>
  ...
  /// Identifies the part of the world in which the contact address is located.
  /// </summary>
  ...
  /// definition.
  /// The permitted values are maintained in CODE_VALUE entity for 
  /// CODE_NAME=ADDRESS_TYPE
  /// </summary>
