// The source file: DISBURSEMENT_STATUS, ID: 371433578, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// This entity defines the various states that a Disbursement may be in at a 
/// given point in time.  A Disbursement must be in one of the states
/// represented in the entity at all times.
/// Examples:
/// Requested
/// Disbursed
/// Suspened
/// </summary>
[Serializable]
public partial class DisbursementStatus: View, ICloneable
{
  ...
  public DisbursementStatus(DisbursementStatus that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new DisbursementStatus Clone() => new(this);
  ...
  public void Assign(DisbursementStatus that)
  {
    base.Assign(that);
