// The source file: DISBURSEMENT_TRAN_RLN_RSN, ID: 371433653, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// The pre-defined business reason for relating two disbursement transactions 
/// together.
/// Example:
/// transaction-1 pays
/// transaction-2
/// </summary>
[Serializable]
public partial class DisbursementTranRlnRsn: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public DisbursementTranRlnRsn()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public DisbursementTranRlnRsn(DisbursementTranRlnRsn that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new DisbursementTranRlnRsn Clone() => new(this);
  ...
  public void Assign(DisbursementTranRlnRsn that)
  {
    base.Assign(that);
