// The source file: EXTERNAL_AGENCY_ADDRESS, ID: 371434328, model: 746.
using System;
...
/// <summary>
/// RESP: OBLGE
/// This entity describes the address of the external agency.
/// </summary>
[Serializable]
public partial class ExternalAgencyAddress: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public ExternalAgencyAddress()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public ExternalAgencyAddress(ExternalAgencyAddress that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new ExternalAgencyAddress Clone() => new(this);
  ...
  public void Assign(ExternalAgencyAddress that)
  {
    base.Assign(that);
    type1 = that.type1;
  ...
  /// Zip_Code5 to further identify the region in which the agency's address is
  /// located.
  /// </summary>
  ...
  /// Identifies the part of the world in which the agency address is located.
  /// </summary>
  [JsonIgnore]
  [DefaultValue("")]
