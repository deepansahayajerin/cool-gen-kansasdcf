// The source file: FUND_TRANSACTION_STATUS, ID: 371434791, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// Defines the various states fo the fund transaction.
/// Examples:
/// For a Deposit type - Open, Closed, Verified.
/// </summary>
[Serializable]
public partial class FundTransactionStatus: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public FundTransactionStatus()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public FundTransactionStatus(FundTransactionStatus that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new FundTransactionStatus Clone() => new(this);
  ...
  public void Assign(FundTransactionStatus that)
  {
    base.Assign(that);
