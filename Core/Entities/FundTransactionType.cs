// The source file: FUND_TRANSACTION_TYPE, ID: 371434842, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// The FUND_TRANSACTION_TYPE defines the kind of transaction.  Every 
/// transaction must fall into one and only one catagory or type of fund
/// transaction.
/// Examples:
///   Deposit
///   Withdrawal	
...
/// </summary>
[Serializable]
public partial class FundTransactionType: View, ICloneable
{
  ...
  public FundTransactionType(FundTransactionType that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new FundTransactionType Clone() => new(this);
  ...
  public void Assign(FundTransactionType that)
  {
    base.Assign(that);
    ...
    fundAffectInd = that.fundAffectInd;
  ...
  /// The date upon which this occurrance of the entity is activated by the 
  ...
  /// <summary>
  /// The value of the FUND_AFFECT_IND attribute.
  /// This attribute will determine if the fund transaction has an increasing or
  /// decreasing amount on the fund balance.  All transaction amounts are kept
  /// in positive amounts.  This attribute will contain either a +1 or a -1 so
  /// that the transaction amount can be multiplied by this indicator and then
  /// added to the fund balance.
  /// </summary>
  [JsonPropertyName("fundAffectInd")]
  [DefaultValue(0)]
  [Member(Index = 6, Type = MemberType.Number, Length = 1)]
  public int FundAffectInd
  {
    get => fundAffectInd;
    set => fundAffectInd = value;
  }
  ...
  /// The timestamp of the most recent update to the occurrance of this entity 
  /// type.
  /// </summary>
