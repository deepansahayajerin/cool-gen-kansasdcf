// The source file: INCARCERATION_ADDRESS, ID: 371435456, model: 746.
using System;
...
/// <summary>
/// RESP: OBLGESTB
/// Address of incarceration location.
/// </summary>
[Serializable]
public partial class IncarcerationAddress: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public IncarcerationAddress()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public IncarcerationAddress(IncarcerationAddress that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new IncarcerationAddress Clone() => new(this);
  ...
  public void Assign(IncarcerationAddress that)
  {
    base.Assign(that);
    ...
    incIdentifier = that.incIdentifier;
    cspNumber = that.cspNumber;
  }

  /// <summary>
  /// The value of the EFFECTIVE_DATE attribute.
  /// The date on which it was verified that the INcarceration is known or 
  /// receives mail at the given address.
  /// </summary>
  ...
  /// The first line of the postal address for the Incarceration.
  /// </summary>
  ...
  /// The second line of postal address for the Incarceration.
  /// </summary>
  ...
  /// </summary>
  [JsonPropertyName("incIdentifier")]
  [DefaultValue(0)]
  [Member(Index = 16, Type = MemberType.Number, Length = 2)]
  public int IncIdentifier
  {
    get => incIdentifier;
    set => incIdentifier = value;
  }
