// The source file: INFORMATION_REQUEST_ASSIGNMENT, ID: 371435610, model: 746.
using System;
...
/// <summary>
/// RESP: SRVPLAN
/// This documents the assignment of an information request to an office service
/// provider.
/// DATA MODEL ALERT!!!!
/// *	The relationship between INFORMATION REQUEST and INFORMATION REQUEST 
/// ASSIGNMENT is not drawn.
/// each INFORMATION REQUEST sometimes is assigned to one or more INFORMATION 
/// REQUEST ASSIGNMENT
/// each INFORMATION REQUEST ASSIGNMENT always assigns one INFORMATION REQUEST
/// *	The relationship between OFFICE SERVICE PROVIDER and INFORMATION REQUEST 
/// ASSIGNMENT is not drawn.
/// each OFFICE SERVICE PROVIDER sometimes is assigned to one or more 
/// INFORMATION REQUEST ASSIGNMENT
/// each INFORMATION REQUEST ASSIGNMENT always assigns one OFFICE SERVICE 
/// PROVIDER.
/// *	Both relationships should be added to the identifier.
/// </summary>
[Serializable]
public partial class InformationRequestAssignment: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public InformationRequestAssignment()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public InformationRequestAssignment(InformationRequestAssignment that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new InformationRequestAssignment Clone() => new(this);
  ...
  public void Assign(InformationRequestAssignment that)
  {
    base.Assign(that);
  ...
  /// </summary>
  [JsonPropertyName("inqNo")]
  [DefaultValue(0L)]
  [Member(Index = 9, Type = MemberType.Number, Length = 10)]
  public long InqNo
  {
    get => inqNo;
    set => inqNo = value;
