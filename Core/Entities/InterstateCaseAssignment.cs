// The source file: INTERSTATE_CASE_ASSIGNMENT, ID: 371436307, model: 746.
using System;
...
/// <summary>
/// RESP: SRVPLAN
/// This documents the assignment of an interstate case to an office service 
/// provider.
/// DATA MODEL ALERT!!!!
/// *	The relationship between INTERSTATE CASE and INTERSTATE CASE ASSIGNMENT is
/// not drawn.
/// each INTERSTATE CASE sometimes is assigned to one or more INTERSTATE CASE 
/// ASSIGNMENT
/// each INTERSTATE CASE ASSIGNMENT always assigns one INTERSTATE CASE
/// *	The relationship between OFFICE SERVICE PROVIDER and INTERSTATE CASE 
/// ASSIGNMENT is not drawn.
/// each OFFICE SERVICE PROVIDER sometimes is assigned to one or more INTERSTATE
/// CASE ASSIGNMENT
/// each INTERSTATE CASE ASSIGNMENT always assigns one OFFICE SERVICE PROVIDER
/// *	Both relationships should be added to the identifier.
/// </summary>
[Serializable]
public partial class InterstateCaseAssignment: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public InterstateCaseAssignment()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public InterstateCaseAssignment(InterstateCaseAssignment that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new InterstateCaseAssignment Clone() => new(this);
  ...
  public void Assign(InterstateCaseAssignment that)
  {
    base.Assign(that);
  ...
  /// </summary>
  [JsonPropertyName("icsDate")]
  [Member(Index = 10, Type = MemberType.Date)]
  public DateTime? IcsDate
  {
    get => icsDate;
    set => icsDate = value;
  }
