// The source file: LEGAL_REFERRAL_ATTACHMENT, ID: 371437024, model: 746.
using System;
...
/// <summary>
/// RESP: OBLGESTB
/// This entity type contains the details of attachements sent to the attorney 
/// along with the referral.
/// </summary>
[Serializable]
public partial class LegalReferralAttachment: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public LegalReferralAttachment()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public LegalReferralAttachment(LegalReferralAttachment that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new LegalReferralAttachment Clone() => new(this);
  ...
  public void Assign(LegalReferralAttachment that)
  {
    base.Assign(that);
    lineNo = that.lineNo;
  ...
  /// Line no of the legal referral attachment line.
  /// </summary>
  ...
  /// Narrative text describing legal referral attachment sent along with the 
