// The source file: OBLIGATION_ASSIGNMENT, ID: 371438051, model: 746.
using System;
...
/// <summary>
/// RESP: SRVPLAN
/// This documents the assignment of an obligation to an office service 
/// provider.
/// DATA MODEL ALERT!!!!
/// *	The relationship between OBLIGATION and OBLIGATION ASSIGNMENT is not 
/// drawn.
/// each OBLIGATION sometimes is assigned to one or more OBLIGATION ASSIGNMENT.
/// each OBLIGATION ASSIGNMENT always assigns one OBLIGATION.
/// *	The relationship between OBLIGATION ASSIGNMENT and OFFICE SERVICE PROVIDER
/// is not drawn.
/// each OFFICE SERVICE PROVIDER sometimes is assigned to one or more OBLIGATION
/// ASSIGNMENT
/// each OBLIGATION ASSIGNMENT always assigns one OFFICE SERVICE PROVIDER
/// *	Both relationships should be added to identifier.
/// </summary>
[Serializable]
public partial class ObligationAssignment: View, ICloneable
{
  ...
  public ObligationAssignment(ObligationAssignment that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new ObligationAssignment Clone() => new(this);
  ...
  public void Assign(ObligationAssignment that)
  {
    base.Assign(that);
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 10, Type = MemberType.Char, Length = CspNo_MaxLength)]
  public string CspNo
  {
    get => cspNo ?? "";
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 14, Type = MemberType.Char, Length = OspCode_MaxLength)]
