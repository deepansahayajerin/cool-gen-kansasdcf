// The source file: PA_REFERRAL_PARTICIPANT, ID: 371438941, model: 746.
using System;
...
/// <summary>
/// RESP: SRVINIT
/// This contains information about a participant on a referral from other 
/// agencies except interstate (CSENET).
/// </summary>
[Serializable]
public partial class PaReferralParticipant: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public PaReferralParticipant()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public PaReferralParticipant(PaReferralParticipant that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new PaReferralParticipant Clone() => new(this);
  ...
  public void Assign(PaReferralParticipant that)
  {
    base.Assign(that);
  ...
  [Member(Index = 6, Type = MemberType.Char, Length = AbsenceCode_MaxLength, Optional
    = true)]
  ...
  [Member(Index = 10, Type = MemberType.Char, Length = LastName_MaxLength, Optional
    = true)]
  ...
  [Member(Index = 11, Type = MemberType.Char, Length = FirstName_MaxLength, Optional
    = true)]
  ...
  /// </summary>
  [JsonPropertyName("mi")]
  [Member(Index = 12, Type = MemberType.Char, Length = Mi_MaxLength, Optional
    = true)]
  public string Mi
  {
    get => mi;
  ...
  [Member(Index = 13, Type = MemberType.Char, Length = Ssn_MaxLength, Optional
    = true)]
  public string Ssn
  {
    get => ssn;
  ...
  [Member(Index = 14, Type = MemberType.Char, Length = PersonNumber_MaxLength, Optional
    = true)]
  ...
  [Member(Index = 16, Type = MemberType.Char, Length = InsurInd_MaxLength, Optional
    = true)]
  ...
  [Member(Index = 17, Type = MemberType.Char, Length = PatEstInd_MaxLength, Optional
    = true)]
  ...
  [Member(Index = 18, Type = MemberType.Char, Length = BeneInd_MaxLength, Optional
    = true)]
  ...
  [Member(Index = 19, Type = MemberType.Char, Length = Role_MaxLength, Optional
    = true)]
  public string Role
  {
    get => role;
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 21, Type = MemberType.Char, Length = PreNumber_MaxLength)]
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 22, Type = MemberType.Char, Length = PafType_MaxLength)]
