// The source file: PAYMENT_METHOD_TYPE, ID: 371439043, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// The Payment_Method_Type defines the type of payment method.  Every 
/// Payment_Request must be described by one and only one type thru its
/// relationship with this entity.  This entity contains all of the possible
/// valid types.
/// Example:
/// EFT
/// Interfund Voucher
...
/// </summary>
[Serializable]
public partial class PaymentMethodType: View, ICloneable
{
  ...
  public PaymentMethodType(PaymentMethodType that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new PaymentMethodType Clone() => new(this);
  ...
  public void Assign(PaymentMethodType that)
  {
    base.Assign(that);
