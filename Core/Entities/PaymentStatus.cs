// The source file: PAYMENT_STATUS, ID: 371439177, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// Defines the various states of that a payment may be in at any given point in
/// time.  A payment must be in one of the states represented in this entity at
/// all times.
/// Examples:
/// Issued
/// Undeliverable
...
/// </summary>
[Serializable]
public partial class PaymentStatus: View, ICloneable
{
  ...
  public PaymentStatus(PaymentStatus that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new PaymentStatus Clone() => new(this);
  ...
  public void Assign(PaymentStatus that)
  {
    base.Assign(that);
