// The source file: PROGRAM_COST_ACCOUNT, ID: 371439782, model: 746.
using System;
...
/// <summary>
/// RESP: FINANCE
/// The Program Cost Account is a further breakdown of monies held within a 
/// fund.  It is a means of categorizing money and also of directing fund
/// transactions.
/// </summary>
[Serializable]
public partial class ProgramCostAccount: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public ProgramCostAccount()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public ProgramCostAccount(ProgramCostAccount that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new ProgramCostAccount Clone() => new(this);
  ...
  public void Assign(ProgramCostAccount that)
  {
    base.Assign(that);
    code = that.code;
    name = that.name;
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 1, Type = MemberType.Char, Length = Code_MaxLength)]
  public string Code
  {
    get => code ?? "";
  ...
  /// The name of the program cost account.
  /// </summary>
  [JsonIgnore]
  [DefaultValue("")]
