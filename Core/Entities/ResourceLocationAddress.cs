// The source file: RESOURCE_LOCATION_ADDRESS, ID: 371440158, model: 746.
using System;
...
/// <summary>
/// RESP: OBLGESTB
/// Address of the location of the resource. This entity was created from 
/// ADDRESS entity.
/// </summary>
[Serializable]
public partial class ResourceLocationAddress: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public ResourceLocationAddress()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public ResourceLocationAddress(ResourceLocationAddress that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new ResourceLocationAddress Clone() => new(this);
  ...
  public void Assign(ResourceLocationAddress that)
  {
    base.Assign(that);
  ...
  /// The first line of the resource's postal address.
  /// </summary>
  ...
  /// The second line of the resource's postal address.
  /// </summary>
  ...
  /// The community where the resource address is located.
  /// </summary>
  ...
  /// The region in which the resource address is located.
  /// </summary>
  ...
  /// The administrative district in which the resource address is loacted.
  /// </summary>
  ...
  /// Identifying the area in which the resource foreign address is loacted.
  /// </summary>
  ...
  /// region in which the resource's address is located.
  /// </summary>
  ...
  /// Zip_Code5 to further identify the region in which the resource's address
  /// is located.
  /// </summary>
  ...
  /// Identifies the part of the world in which the resource address is located.
  /// </summary>
