// The source file: SERVICE_PROVIDER_ADDRESS, ID: 371440263, model: 746.
using System;
...
/// <summary>
/// RESP: SRVPLAN
/// This entity is used for service providers that are not located in the CSE 
/// office.		
/// This includes contractor addresses.
/// This excludes CSE offices.
/// </summary>
[Serializable]
public partial class ServiceProviderAddress: View, ICloneable
{
  ...
  public ServiceProviderAddress(ServiceProviderAddress that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new ServiceProviderAddress Clone() => new(this);
  ...
  public void Assign(ServiceProviderAddress that)
  {
    base.Assign(that);
    type1 = that.type1;
  ...
  /// state abbreviation or Province abbreviation for the service provider
  /// </summary>
  [JsonIgnore]
  [DefaultValue("")]
