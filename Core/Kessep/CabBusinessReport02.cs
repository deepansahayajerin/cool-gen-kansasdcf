// Program: CAB_BUSINESS_REPORT_02, ID: 371057424, model: 746.
// Short name: SWE02509
using System;
...
/// <summary>
/// A program: CAB_BUSINESS_REPORT_02.
/// </summary>
[Serializable]
public partial class CabBusinessReport02: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the CAB_BUSINESS_REPORT_02 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new CabBusinessReport02(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of CabBusinessReport02.
  /// </summary>
  public CabBusinessReport02(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
  ...
  public void Run()
  {
    switch(TrimEnd(import.EabFileHandling.Action))
    {
      case "OPEN":
        ...
        local.EabReportSend.ReportNoPart2 = "02";
