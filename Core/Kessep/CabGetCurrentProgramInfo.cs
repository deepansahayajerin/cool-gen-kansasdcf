// Program: CAB_GET_CURRENT_PROGRAM_INFO, ID: 372927094, model: 746.
// Short name: SWEFD715
using System;
...
/// <summary>
/// A program: CAB_GET_CURRENT_PROGRAM_INFO.
/// </summary>
[Serializable]
public partial class CabGetCurrentProgramInfo: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the CAB_GET_CURRENT_PROGRAM_INFO program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new CabGetCurrentProgramInfo(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of CabGetCurrentProgramInfo.
  /// </summary>
  public CabGetCurrentProgramInfo(IContext context, Import import, Export export)
    :
    base(context)
  {
    this.import = import;
