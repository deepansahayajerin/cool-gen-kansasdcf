// Program: CAB_SEARCH_CLIENT_BATCH, ID: 1902493465, model: 746.
// Short name: SWE03596
using System;
...
/// <summary>
/// A program: CAB_SEARCH_CLIENT_BATCH.
/// </summary>
[Serializable]
public partial class CabSearchClientBatch: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the CAB_SEARCH_CLIENT_BATCH program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new CabSearchClientBatch(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of CabSearchClientBatch.
  /// </summary>
  public CabSearchClientBatch(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  private static void MoveExport2(Export.ExportGroup source,
    EabSearchClientBatch.Export.ExportGroup target)
  {
  ...
  private static void MoveExport3(EabSearchClientBatch.Export.
  ...
  private void UseEabSearchClientBatch()
  {
    var useImport = new EabSearchClientBatch.Import();
    var useExport = new EabSearchClientBatch.Export();
    ...
    Call(EabSearchClientBatch.Execute, useImport, useExport);
