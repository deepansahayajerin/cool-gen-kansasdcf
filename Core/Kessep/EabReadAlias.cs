// Program: EAB_READ_ALIAS, ID: 371755407, model: 746.
// Short name: SWEXIR10
using System;
...
/// </summary>
[Serializable]
public partial class EabReadAlias: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the EAB_READ_ALIAS program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new EabReadAlias(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of EabReadAlias.
  /// </summary>
  public EabReadAlias(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXIR10", context, import, export, EabOptions.NoIefParams);
  }
#endregion
