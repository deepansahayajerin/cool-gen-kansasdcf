// Program: EAB_READ_FEDERAL_QUARTERLY_WAGE, ID: 371072740, model: 746.
// Short name: SWEXIC04
using System;
...
/// <summary>
/// A program: EAB_READ_FEDERAL_QUARTERLY_WAGE.
/// </summary>
[Serializable]
public partial class EabReadFederalQuarterlyWage: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the EAB_READ_FEDERAL_QUARTERLY_WAGE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new EabReadFederalQuarterlyWage(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of EabReadFederalQuarterlyWage.
  /// </summary>
  public EabReadFederalQuarterlyWage(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXIC04", context, import, export, EabOptions.Hpvp);
  }
#endregion
...
#region Structures
  ...
  public class Export
  {
    ...
    /// </summary>
    [JsonPropertyName("eabFileHandling")]
    [Member(Index = 9, AccessFields = false, Members = new[] { "Status" })]
    public EabFileHandling EabFileHandling
    {
      get => eabFileHandling ??= new();
      set => eabFileHandling = value;
