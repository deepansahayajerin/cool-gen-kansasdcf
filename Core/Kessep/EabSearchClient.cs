// Program: EAB_SEARCH_CLIENT, ID: 373427517, model: 746.
// Short name: SWEXIR90
using System;
...
/// </summary>
[Serializable]
public partial class EabSearchClient: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the EAB_SEARCH_CLIENT program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new EabSearchClient(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of EabSearchClient.
  /// </summary>
  public EabSearchClient(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXIR90", context, import, export, EabOptions.NoIefParams);
  }
#endregion
