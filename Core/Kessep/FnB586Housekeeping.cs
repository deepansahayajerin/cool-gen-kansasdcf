// Program: FN_B586_HOUSEKEEPING, ID: 1902467261, model: 746.
// Short name: SWE03742
using System;
...
/// <summary>
/// A program: FN_B586_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class FnB586Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B586_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB586Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB586Housekeeping.
  /// </summary>
  public FnB586Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // **********************************************************
    local.ProgramProcessingInfo.Name = "SWEFB586";
    local.Start.Count = 1;
