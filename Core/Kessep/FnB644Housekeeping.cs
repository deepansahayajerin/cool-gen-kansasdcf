// Program: FN_B644_HOUSEKEEPING, ID: 372691363, model: 746.
// Short name: SWE02457
using System;
...
/// <summary>
/// A program: FN_B644_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class FnB644Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B644_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB644Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB644Housekeeping.
  /// </summary>
  public FnB644Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // **********************************************************
    local.ProgramProcessingInfo.Name = "SWEFB644";
    ...
    {
      export.CreateMissing.Flag =
        Substring(export.ProgramProcessingInfo.ParameterList, 9, 1);

      if (AsChar(export.CreateMissing.Flag) == 'Y')
      {
        // **********************************************************
        ...
        local.EabFileHandling.Action = "WRITE";
        local.EabReportSend.RptDetail =
          "The PPI Parmlist requested that all missing summaries be created." +
          "" + "   ";
