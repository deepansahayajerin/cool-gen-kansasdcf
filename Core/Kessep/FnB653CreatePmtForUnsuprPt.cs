// Program: FN_B653_CREATE_PMT_FOR_UNSUPR_PT, ID: 372728038, model: 746.
// Short name: SWEF653B
using System;
...
/// <summary>
/// <para>
/// A program: FN_B653_CREATE_PMT_FOR_UNSUPR_PT.
/// </para>
/// <para>
/// RESP: FINANCE
/// This proc step processes unsupressed pasthrus.
/// </para>
/// </summary>
[Serializable]
[ProcedureStep(ProcedureType.Batch)]
public partial class FnB653CreatePmtForUnsuprPt: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B653_CREATE_PMT_FOR_UNSUPR_PT program.
  /// </summary>
  [Entry]
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB653CreatePmtForUnsuprPt(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB653CreatePmtForUnsuprPt.
  /// </summary>
  public FnB653CreatePmtForUnsuprPt(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  {
    // ---------------------------------------------
    // This batch procedure is a copy of SWEFB641 and was created to process 
    // passthru that have been unsupressed.  SWEFB641 does not processes
    // passthrus because they cannot be "netted" out with backoff disbursements.
    // SWEFB651 only runs once a month so this process was created (copied) to
    // run every night and only process passthrus that are in a released
    // status.
    // ---------------------------------------------
    // ---------------------------------------------
    // Date	By	Description
    ...
    // 4/12/00    Fangman  PR 93146  Added code to cancel payment and deny 
    ...
    return ReadEach("ReadCsePersonCsePersonAccountDisbursementTransaction",
      (db, command) =>
      {
        ...
        db.SetNullableInt32(
          ...
          local.Hardcoded.HardcodePassthru.SystemGeneratedIdentifier);
      },
      (db, reader) =>
      {
...
#region Structures
  ...
  public class Local
  {
    ...
    {
      /// <summary>
      /// A value of HardcodePassthruz.
      /// </summary>
      [JsonPropertyName("hardcodePassthruz")]
      public DisbursementType HardcodePassthruz
      {
        get => hardcodePassthruz ??= new();
        set => hardcodePassthruz = value;
      }
      ...
      private DisbursementType hardcodePassthruz;
  ...
  public class Entities
  {
    ...
    /// <summary>
    /// A value of ReadForAeNotification.
    /// </summary>
    [JsonPropertyName("readForAeNotification")]
    public DisbursementTransaction ReadForAeNotification
    {
      get => readForAeNotification ??= new();
      set => readForAeNotification = value;
    }
    ...
    private PaymentRequest paymentRequest;
    private DisbursementTransaction readForAeNotification;
