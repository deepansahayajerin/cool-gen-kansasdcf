// Program: FN_B663_CR_AR_STMT_DRVR_FILE, ID: 372548995, model: 746.
// Short name: SWEF663B
using System;
...
/// <summary>
/// A program: FN_B663_CR_AR_STMT_DRVR_FILE.
/// </summary>
[Serializable]
[ProcedureStep(ProcedureType.Batch)]
public partial class FnB663CrArStmtDrvrFile: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B663_CR_AR_STMT_DRVR_FILE program.
  /// </summary>
  [Entry]
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB663CrArStmtDrvrFile(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB663CrArStmtDrvrFile.
  /// </summary>
  public FnB663CrArStmtDrvrFile(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // needed to produce AR statements.
    // --
...
Test:
  ...
  private void UseFnB663BatchInitialization()
  {
    var useImport = new FnB663BatchInitialization.Import();
    var useExport = new FnB663BatchInitialization.Export();

    Call(FnB663BatchInitialization.Execute, useImport, useExport);
