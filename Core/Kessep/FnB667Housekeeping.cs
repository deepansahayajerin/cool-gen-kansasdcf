// Program: FN_B667_HOUSEKEEPING, ID: 372273894, model: 746.
// Short name: SWE02359
using System;
...
/// <summary>
/// A program: FN_B667_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class FnB667Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B667_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB667Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB667Housekeeping.
  /// </summary>
  public FnB667Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    local.ProgramProcessingInfo.Name = "SWEFB667";
    ...
    export.RetroDebtAdjustment.Code = "RETDEBT";
