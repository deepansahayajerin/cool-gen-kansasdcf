// Program: FN_B668_HOUSEKEEPING, ID: 372275534, model: 746.
// Short name: SWE02360
using System;
...
/// <summary>
/// A program: FN_B668_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class FnB668Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B668_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB668Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB668Housekeeping.
  /// </summary>
  public FnB668Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    local.ProgramProcessingInfo.Name = "SWEFB668";
    ...
    export.CaseRoleChgAdjustment.Code = "RETCROL";

    if (ReadCollectionAdjustmentReason())
    {
      export.CaseRoleChgAdjustment.Assign(entities.CollectionAdjustmentReason);
    }
    else
    {
    ...
    if (IsEmpty(export.CaseRoleChgAdjustment.Description))
    {
      export.CaseRoleChgAdjustment.Description =
        export.CaseRoleChgAdjustment.Name;
    }
  }
  ...
  private bool ReadCollectionAdjustmentReason()
  {
    ...
    return Read("ReadCollectionAdjustmentReason",
      ...
      {
        db.
          SetString(command, "obTrnRlnRsnCd", export.CaseRoleChgAdjustment.Code);
...
#region Structures
  ...
  public class Export
  {
    ...
    /// <summary>
    /// A value of CaseRoleChgAdjustment.
    /// </summary>
    [JsonPropertyName("caseRoleChgAdjustment")]
    public CollectionAdjustmentReason CaseRoleChgAdjustment
    {
      get => caseRoleChgAdjustment ??= new();
      set => caseRoleChgAdjustment = value;
    }
    ...
    private CollectionAdjustmentReason caseRoleChgAdjustment;
  }
