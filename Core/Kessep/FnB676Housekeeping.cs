// Program: FN_B676_HOUSEKEEPING, ID: 372449468, model: 746.
// Short name: SWE02340
using System;
...
/// <summary>
/// A program: FN_B676_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class FnB676Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B676_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB676Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB676Housekeeping.
  /// </summary>
  public FnB676Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    export.ProgramProcessingInfo.Name = "SWEFB676";
