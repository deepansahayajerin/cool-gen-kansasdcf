// Program: FN_B680_AR_EXTRACT_DATA1, ID: 374555552, model: 746.
// Short name: SWEXEW12
using System;
...
/// <summary>
/// A program: FN_B680_AR_EXTRACT_DATA1.
/// </summary>
[Serializable]
public partial class FnB680ArExtractData1: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B680_AR_EXTRACT_DATA1 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB680ArExtractData1(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB680ArExtractData1.
  /// </summary>
  public FnB680ArExtractData1(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXEW12", context, import, export, EabOptions.Hpvp);
  }
#endregion
