// Program: FN_B695_PRINT_CONTROL, ID: 374411710, model: 746.
// Short name: SWE00146
using System;
...
/// <summary>
/// A program: FN_B695_PRINT_CONTROL.
/// </summary>
[Serializable]
public partial class FnB695PrintControl: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B695_PRINT_CONTROL program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB695PrintControl(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB695PrintControl.
  /// </summary>
  public FnB695PrintControl(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
