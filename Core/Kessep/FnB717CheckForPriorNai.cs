// Program: FN_B717_CHECK_FOR_PRIOR_NAI, ID: 373348471, model: 746.
// Short name: SWE02996
using System;
...
/// <summary>
/// A program: FN_B717_CHECK_FOR_PRIOR_NAI.
/// </summary>
[Serializable]
public partial class FnB717CheckForPriorNai: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B717_CHECK_FOR_PRIOR_NAI program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB717CheckForPriorNai(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB717CheckForPriorNai.
  /// </summary>
  public FnB717CheckForPriorNai(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
