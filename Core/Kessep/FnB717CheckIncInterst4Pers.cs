// Program: FN_B717_CHECK_INC_INTERST_4_PERS, ID: 373348587, model: 746.
// Short name: SWE03028
using System;
...
/// <summary>
/// A program: FN_B717_CHECK_INC_INTERST_4_PERS.
/// </summary>
[Serializable]
public partial class FnB717CheckIncInterst4Pers: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B717_CHECK_INC_INTERST_4_PERS program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB717CheckIncInterst4Pers(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB717CheckIncInterst4Pers.
  /// </summary>
  public FnB717CheckIncInterst4Pers(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
