// Program: FN_B717_CHECK_PRIOR_AFI_4_CASE, ID: 373348953, model: 746.
// Short name: SWE03016
using System;
...
/// <summary>
/// A program: FN_B717_CHECK_PRIOR_AFI_4_CASE.
/// </summary>
[Serializable]
public partial class FnB717CheckPriorAfi4Case: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B717_CHECK_PRIOR_AFI_4_CASE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB717CheckPriorAfi4Case(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB717CheckPriorAfi4Case.
  /// </summary>
  public FnB717CheckPriorAfi4Case(IContext context, Import import, Export export)
    :
    base(context)
  {
    this.import = import;
