// Program: FN_B717_CRUD_STATS_RPT_BY_COUNT, ID: 373349947, model: 746.
// Short name: SWE03049
using System;
...
/// <summary>
/// A program: FN_B717_CRUD_STATS_RPT_BY_COUNT.
/// </summary>
[Serializable]
public partial class FnB717CrudStatsRptByCount: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B717_CRUD_STATS_RPT_BY_COUNT program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB717CrudStatsRptByCount(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB717CrudStatsRptByCount.
  /// </summary>
  public FnB717CrudStatsRptByCount(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
  ...
  public void Run()
  {
      ...
      switch(import.Program.SystemGeneratedIdentifier)
      {
        case 1:
          local.StatsReport.Column1 =
            local.StatsReport.Column1.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 2:
          local.StatsReport.Column2 =
            local.StatsReport.Column2.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 3:
          local.StatsReport.Column3 =
            local.StatsReport.Column3.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 4:
          local.StatsReport.Column4 =
            local.StatsReport.Column4.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 5:
          local.StatsReport.Column5 =
            local.StatsReport.Column5.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 6:
          local.StatsReport.Column6 =
            local.StatsReport.Column6.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 7:
          local.StatsReport.Column7 =
            local.StatsReport.Column7.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 8:
          local.StatsReport.Column8 =
            local.StatsReport.Column8.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 9:
          local.StatsReport.Column9 =
            local.StatsReport.Column9.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 10:
          local.StatsReport.Column10 =
            local.StatsReport.Column10.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 11:
          local.StatsReport.Column11 =
            local.StatsReport.Column11.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 12:
          local.StatsReport.Column12 =
            local.StatsReport.Column12.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 13:
          local.StatsReport.Column13 =
            local.StatsReport.Column13.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 14:
          local.StatsReport.Column14 =
            local.StatsReport.Column14.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();

          break;
        case 15:
          local.StatsReport.Column15 =
            local.StatsReport.Column15.GetValueOrDefault() + import
            .Increment.Column1.GetValueOrDefault();
    ...
    else
    {
      switch(import.Program.SystemGeneratedIdentifier)
      {
        case 1:
          local.StatsReport.Column1 =
            import.Increment.Column1.GetValueOrDefault();
