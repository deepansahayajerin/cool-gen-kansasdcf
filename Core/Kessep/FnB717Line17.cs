// Program: FN_B717_LINE_17, ID: 373359288, model: 746.
// Short name: SWE03044
using System;
...
/// <summary>
/// A program: FN_B717_LINE_17.
/// </summary>
[Serializable]
public partial class FnB717Line17: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B717_LINE_17 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB717Line17(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB717Line17.
  /// </summary>
  public FnB717Line17(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    local.Create.LineNumber = 17;
    local.LineNumber.Count = 17;
...
Test:
        ...
        .ProgramCheckpointRestart.UpdateFrequencyCount.GetValueOrDefault())
      {
        ...
        local.ProgramCheckpointRestart.RestartInfo = "17 " + NumberToString
    ...
    ReadCashReceiptTypeCashReceiptEventCashReceiptSourceType()
  {
    ...
    return ReadEach("ReadCashReceiptTypeCashReceiptEventCashReceiptSourceType",
      ...
      (db, reader) =>
      {
        ...
        entities.Starved.CrtIdentifier = db.GetInt32(reader, 0);
        entities.CashReceiptDetailStatHistory.CrtIdentifier =
          db.GetInt32(reader, 0);
        entities.CashReceiptDetailStatHistory.CrtIdentifier =
          db.GetInt32(reader, 0);
        ...
        entities.Starved.CstIdentifier = db.GetInt32(reader, 1);
        entities.Starved.CstIdentifier = db.GetInt32(reader, 1);
        entities.CashReceiptDetailStatHistory.CstIdentifier =
          db.GetInt32(reader, 1);
        entities.CashReceiptDetailStatHistory.CstIdentifier =
        ...
        entities.Starved.CrvIdentifier = db.GetInt32(reader, 2);
        entities.CashReceiptDetailStatHistory.CrvIdentifier =
          db.GetInt32(reader, 2);
        entities.CashReceiptDetailStatHistory.CrvIdentifier =
          db.GetInt32(reader, 2);
        entities.Starved.SequentialIdentifier = db.GetInt32(reader, 3);
        entities.CashReceiptDetailStatHistory.CrdIdentifier =
          db.GetInt32(reader, 3);
