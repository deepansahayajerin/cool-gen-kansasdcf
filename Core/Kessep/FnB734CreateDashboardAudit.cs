...
#region Implementation
  ...
  private void CreateDashboardAuditData()
  {
    ...
    var office = import.DashboardAuditData.Office.GetValueOrDefault();
    ...
    var fte = import.DashboardAuditData.Fte.GetValueOrDefault();
    var collectionAmount =
      import.DashboardAuditData.CollectionAmount.GetValueOrDefault();
    ...
    var debtBalanceDue =
      import.DashboardAuditData.DebtBalanceDue.GetValueOrDefault();
    ...
    var legalReferralNumber =
      import.DashboardAuditData.LegalReferralNumber.GetValueOrDefault();
    var daysReported =
      import.DashboardAuditData.DaysReported.GetValueOrDefault();
