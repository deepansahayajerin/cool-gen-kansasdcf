...
#region Implementation
  ...
  public void Run()
  {
    ...
    if (!IsExitState("ACO_NN0000_ALL_OK"))
    {
      ...
      local.EabReportSend.RptDetail = "Error returned from initialization: " + local
      ...
      local.Local1.Index)
    {
      ...
      // ------------------------------------------------------------------------------
      foreach(var item in ReadDashboardPerformanceMetrics())
      {
        DeleteDashboardPerformanceMetrics();
      }

      foreach(var item in ReadDashboardOutputMetrics())
      {
      ...
      // ------------------------------------------------------------------------------
      foreach(var item in ReadDashboardStagingPriority12())
      {
        try
        {
      ...
      foreach(var item in ReadDashboardStagingPriority35())
      {
        try
        {
    ...
    if (!IsExitState("ACO_NN0000_ALL_OK"))
    {
      ...
      local.EabReportSend.RptDetail = "Error returned from Priority " + NumberToString
        (local.Local1.Index + 1, 14, 2) + ": " + local
        .ExitStateWorkArea.Message;
      UseCabErrorReport2();
      ExitState = "ACO_NN0000_ABEND_FOR_BATCH";
    ...
    local.ProgramProcessingInfo.ParameterList = local.TextWorkArea.Text10 + Substring
  ...
  private void UseFnB734DashboardInitialization()
  {
    ...
    Call(FnB734DashboardInitialization.Execute, useImport, useExport);
  ...
  private void UseFnB734DeterContractorHistory()
  {
    ...
    Call(FnB734DeterContractorHistory.Execute, useImport, useExport);
  }
  ...
  private void UseFnB734Pri1FederalIncentives()
  {
    ...
    Call(FnB734Pri1FederalIncentives.Execute, useImport, useExport);
  }
  ...
  private void UseFnB734Pri2PerformanceMetric()
  {
    ...
    Call(FnB734Pri2PerformanceMetric.Execute, useImport, useExport);
  }
  ...
  private void UseFnB734Pri3KeyOutputMetrics()
  {
    ...
    Call(FnB734Pri3KeyOutputMetrics.Execute, useImport, useExport);
  }
  ...
  private void UseFnB734Pri4PyramidReport()
  {
    ...
    Call(FnB734Pri4PyramidReport.Execute, useImport, useExport);
  }
  ...
  private void UseFnB734Pri5WorkerAndTeam()
  {
    ...
    Call(FnB734Pri5WorkerAndTeam.Execute, useImport, useExport);
  }
...
#region Structures
  ...
  public class Local
  {
    ...
    public class LocalGroup
    {
      ...
      /// </summary>
      [JsonPropertyName("glocalPeriodStart")]
      ...
      /// </summary>
      [JsonPropertyName("glocalPeriodEnd")]
      ...
      /// </summary>
      [JsonPropertyName("glocalFyStart")]
      ...
      /// </summary>
      [JsonPropertyName("glocalAuditRecs")]
    ...
    /// </summary>
    [JsonPropertyName("startSubscript")]
