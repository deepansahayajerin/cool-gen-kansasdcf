...
#region Implementation
  ...
  public void Run()
  {
        ...
        local.Common.Count)
      {
        switch(local.Common.Count)
        {
          ...
          case 2:
            ...
            local.EabReportSend.RptDetail = "     Processing Date: " + local
              .TextWorkArea.Text10;
          ...
          case 3:
            ...
            break;
          case 4:
            local.EabReportSend.RptDetail = "       Priority     : " + export
              .Restart.DashboardPriority;
    ...
    for(local.Common.Count = 1; local.Common.Count <= 11; ++local.Common.Count)
    {
      switch(local.Common.Count)
      {
        case 1:
          ...
          break;
        case 2:
          local.EabReportSend.RptDetail = "       Starting Priority : " + export
            .Start.DashboardPriority;

          break;
        case 3:
          local.EabReportSend.RptDetail = "       Ending Priority   : " + export
            .End.DashboardPriority;

          break;
        case 4:
          UseCabDate2TextWithHyphens4();
          local.EabReportSend.RptDetail = "       Starting Rpt Date : " + local
            .TextWorkArea.Text10;

          break;
        case 5:
          UseCabDate2TextWithHyphens3();
          local.EabReportSend.RptDetail = "       Ending Rpt Date   : " + local
            .TextWorkArea.Text10;

          break;
        case 6:
          local.EabReportSend.RptDetail = "       Fiscal Year       : " + local
            .FiscalYearDesignation.Text3;
        ...
        case 7:
          ...
          {
            local.EabReportSend.RptDetail = "       Audit Flag        : " + local
              .Audit.Flag;
          }
        ...
        case 9:
          ...
          local.EabReportSend.RptDetail = "       Last Run Date     : " + local
            .TextWorkArea.Text10;
        ...
        switch(local.Common.Count)
        {
          case 1:
            ...
            local.EabReportSend.RptDetail =
              ...
              export.Export1.Item.GexportAuditRec.Flag;
    ...
    if (AsChar(export.ProgramCheckpointRestart.RestartInd) != 'Y')
    {
      ...
      UseCabDate2TextWithHyphens1();
      export.ProgramCheckpointRestart.RestartInfo =
        Substring(export.ProgramCheckpointRestart.RestartInfo, 250, 1, 59) + local
        .TextWorkArea.Text10;
    }
  }
  ...
  private void UseFnBuildReportTimeframe1()
  {
    ...
    Call(FnBuildReportTimeframe.Execute, useImport, useExport);
  ...
  private void CreateDashboardAuditData()
  {
    ...
    Update("CreateDashboardAuditData",
      (db, command) =>
      {
        ...
        db.SetNullableDate(command, "collCreatedDt", default(DateTime));
  ...
  {
    export.DashboardAuditData.Populated = false;
    ...
    return Read("ReadDashboardAuditData",
      ...
      (db, reader) =>
      {
        ...
        export.DashboardAuditData.Populated = true;
      });
  }
#endregion
...
#region Structures
  ...
  public class Export
  {
    ...
    public class ExportGroup
    {
      ...
      /// </summary>
      [JsonPropertyName("gexportPeriodStart")]
      ...
      /// </summary>
      [JsonPropertyName("gexportPeriodEnd")]
      ...
      /// </summary>
      [JsonPropertyName("gexportFyStart")]
      ...
      /// </summary>
      [JsonPropertyName("gexportAuditRec")]
    ...
    /// </summary>
    [JsonPropertyName("restartGroupSubscript")]
  ...
  public class Local
  {
    ...
    /// </summary>
    [JsonPropertyName("fiscalYearDesignation")]
    ...
    /// </summary>
    [JsonPropertyName("latestPeriodEnd")]
    ...
    /// </summary>
    [JsonPropertyName("earliestPeriodStart")]
