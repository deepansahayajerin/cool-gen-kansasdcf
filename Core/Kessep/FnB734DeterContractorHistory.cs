...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var item in ReadCseOrganizationCseOrganizationCseOrganizationRelationship())
      
    {
      ...
      {
        foreach(var item1 in ReadContractorHistory2())
        {
      ...
      foreach(var item1 in ReadContractorHistoryCseOrganization())
      {
...
ReadEach:
  ...
  private bool ReadContractorHistory1()
  {
    entities.Read.Populated = false;

    return Read("ReadContractorHistory1",
      (db, command) =>
      {
        db.
  ...
  private IEnumerable<bool> ReadContractorHistory2()
  {
    entities.ContractorHistory.Populated = false;

    return ReadEach("ReadContractorHistory2",
      (db, command) =>
      {
        db.SetString(
  ...
  private IEnumerable<bool> ReadContractorHistoryCseOrganization()
  {
    entities.Contractor2NdRead.Populated = false;
    entities.ContractorHistory.Populated = false;

    return ReadEach("ReadContractorHistoryCseOrganization",
      (db, command) =>
      {
        db.SetString(
          command, "fk0CktCseOrgatypeCode", entities.JudicalDistrict.Type1);
...
#region Structures
  ...
  public class Local
  {
    ...
    /// </summary>
    [JsonPropertyName("endOfTheMonth")]
  ...
  public class Entities
  {
    ...
    /// </summary>
    [JsonPropertyName("contractorRead")]
    ...
    /// </summary>
    [JsonPropertyName("judicalDistrictRead")]
    ...
    /// </summary>
    [JsonPropertyName("contractor2NdRead")]
