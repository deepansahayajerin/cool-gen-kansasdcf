...
ReadEach1:
    ...
    foreach(var item in ReadCaseCaseAssignment())
    {
      ...
      local.Statewide.CasesUnderOrderDenominator =
        local.Statewide.CasesUnderOrderDenominator.GetValueOrDefault() + 1;
      ...
      if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
      {
        ...
        local.Local1.Update.G.CasesUnderOrderDenominator =
          local.Local1.Item.G.CasesUnderOrderDenominator.GetValueOrDefault() + 1
          ;
...
ReadEach2:
      ...
      else
      {
        ...
        local.Statewide.CasesUnderOrderNumerator =
          local.Statewide.CasesUnderOrderNumerator.GetValueOrDefault() + 1;
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.CasesUnderOrderNumerator =
            local.Local1.Item.G.CasesUnderOrderNumerator.GetValueOrDefault() + 1
            ;
        }
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.Contractor.Item.Gcontractor.ContractorNumber))
        {
          local.Contractor.Update.Gcontractor.CasesUnderOrderDenominator =
            local.Contractor.Item.Gcontractor.CasesUnderOrderDenominator.
              GetValueOrDefault() + local
            .Local1.Item.G.CasesUnderOrderDenominator.GetValueOrDefault();
          local.Contractor.Update.Gcontractor.CasesUnderOrderNumerator =
            local.Contractor.Item.Gcontractor.CasesUnderOrderNumerator.
              GetValueOrDefault() + local
            .Local1.Item.G.CasesUnderOrderNumerator.GetValueOrDefault();
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.ContractorCseOrganization.Code))
        {
          local.Contractor.Update.Gcontractor.PrevYrCaseNumerator =
            local.Contractor.Item.Gcontractor.PrevYrCaseNumerator.
              GetValueOrDefault() + entities
            .PreviousYear.CasesUnderOrderNumerator.GetValueOrDefault();
          local.Contractor.Update.Gcontractor.PrevYrCaseDenominator =
            local.Contractor.Item.Gcontractor.PrevYrCaseDenominator.
              GetValueOrDefault() + entities
            .PreviousYear.CasesUnderOrderDenominator.GetValueOrDefault();
...
ReadEach3:
    ...
    foreach(var item in ReadDashboardStagingPriority7())
    {
      ...
      if (local.Temp.CasesUnderOrderDenominator.GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.Temp.CasesUnderOrderPercent =
          Math.Round((decimal)local.Temp.CasesUnderOrderNumerator.
            GetValueOrDefault() /
          local.Temp.CasesUnderOrderDenominator.GetValueOrDefault(), 3,
      ...
      if (local.Temp.PrevYrCaseDenominator.GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.Temp.CasesUndrOrdrPrevYrPct =
          Math.Round((decimal)local.Temp.PrevYrCaseNumerator.
            GetValueOrDefault() /
          local.Temp.PrevYrCaseDenominator.GetValueOrDefault(), 3,
          MidpointRounding.AwayFromZero);
      }
      ...
      if (local.Temp.CasesUndrOrdrPrevYrPct.GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.Temp.PctChgBtwenYrsCaseUndrOrdr =
          Math.Round((
            local.Temp.CasesUnderOrderPercent.GetValueOrDefault() - local
          .Temp.CasesUndrOrdrPrevYrPct.GetValueOrDefault()) /
          local.Temp.CasesUndrOrdrPrevYrPct.GetValueOrDefault(), 3,
          MidpointRounding.AwayFromZero);
      }
    ...
    foreach(var item in ReadDashboardStagingPriority8())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.CasesUnderOrderPercent,
        local.PrevRank.CasesUnderOrderPercent.GetValueOrDefault()))
      {
  ...
  private void CreateDashboardStagingPriority1()
  {
    ...
    var casesUnderOrderPercent =
      local.Contractor.Item.Gcontractor.CasesUnderOrderPercent.
        GetValueOrDefault();
    var param = 0M;
    var contractorNumber =
      local.Contractor.Item.Gcontractor.ContractorNumber ?? "";
    var prevYrCaseNumerator =
      local.Contractor.Item.Gcontractor.PrevYrCaseNumerator.GetValueOrDefault();
      
    var prevYrCaseDenominator =
      local.Contractor.Item.Gcontractor.PrevYrCaseDenominator.
        GetValueOrDefault();
    var casesUndrOrdrPrevYrPct =
      local.Contractor.Item.Gcontractor.CasesUndrOrdrPrevYrPct.
        GetValueOrDefault();
    var pctChgBtwenYrsCaseUndrOrdr =
      local.Contractor.Item.Gcontractor.PctChgBtwenYrsCaseUndrOrdr.
        GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority2()
  {
    ...
    var casesUnderOrderNumerator =
      local.Local1.Item.G.CasesUnderOrderNumerator.GetValueOrDefault();
    var casesUnderOrderDenominator =
      local.Local1.Item.G.CasesUnderOrderDenominator.GetValueOrDefault();
    var casesUnderOrderPercent =
      local.Local1.Item.G.CasesUnderOrderPercent.GetValueOrDefault();
    var casesUnderOrderRank =
      local.Local1.Item.G.CasesUnderOrderRank.GetValueOrDefault();
    var param = 0M;
  ...
  private void CreateDashboardStagingPriority3()
  {
    ...
    var casesUnderOrderNumerator =
      local.Statewide.CasesUnderOrderNumerator.GetValueOrDefault();
    var casesUnderOrderDenominator =
      local.Statewide.CasesUnderOrderDenominator.GetValueOrDefault();
    var casesUnderOrderPercent =
      local.Statewide.CasesUnderOrderPercent.GetValueOrDefault();
    var casesUnderOrderRank =
      local.Statewide.CasesUnderOrderRank.GetValueOrDefault();
    var param = 0M;
  ...
  {
    var casesUnderOrderPercent =
      local.Temp.CasesUnderOrderPercent.GetValueOrDefault();
    var prevYrCaseNumerator =
      local.Temp.PrevYrCaseNumerator.GetValueOrDefault();
    var prevYrCaseDenominator =
      local.Temp.PrevYrCaseDenominator.GetValueOrDefault();
    var casesUndrOrdrPrevYrPct =
      local.Temp.CasesUndrOrdrPrevYrPct.GetValueOrDefault();
    var pctChgBtwenYrsCaseUndrOrdr =
      local.Temp.PctChgBtwenYrsCaseUndrOrdr.GetValueOrDefault();
  ...
  {
    var casesUnderOrderRank =
      local.Temp.CasesUnderOrderRank.GetValueOrDefault();
...
#region Structures
  ...
  public class Local
  {
    ...
    /// </summary>
    [JsonPropertyName("contractorDashboardStagingPriority12")]
