...
ReadEach:
    ...
    foreach(var item in ReadLegalAction())
    {
      ...
      local.Statewide.IwoPerObligCaseNumerator =
        local.Statewide.IwoPerObligCaseNumerator.GetValueOrDefault() + 1;
      ...
      if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
      {
        ...
        local.Local1.Update.G.IwoPerObligCaseNumerator =
          local.Local1.Item.G.IwoPerObligCaseNumerator.GetValueOrDefault() + 1;
      }
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.Contractor.Item.Gcontractor.ContractorNumber))
        {
          local.Contractor.Update.Gcontractor.IwoPerObligCaseDenominator =
            local.Contractor.Item.Gcontractor.IwoPerObligCaseDenominator.
              GetValueOrDefault() + local
            .Local1.Item.G.IwoPerObligCaseDenominator.GetValueOrDefault();
          local.Contractor.Update.Gcontractor.IwoPerObligCaseNumerator =
            local.Contractor.Item.Gcontractor.IwoPerObligCaseNumerator.
              GetValueOrDefault() + local
            .Local1.Item.G.IwoPerObligCaseNumerator.GetValueOrDefault();
...
Next:
    ...
    foreach(var item in ReadDashboardStagingPriority6())
    {
      ...
      if (local.Temp.IwoPerObligCaseDenominator.GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.Temp.IwoPerObligCaseAverage =
          Math.Round((decimal)local.Temp.IwoPerObligCaseNumerator.
            GetValueOrDefault() /
          local.Temp.IwoPerObligCaseDenominator.GetValueOrDefault(), 2,
    ...
    foreach(var item in ReadDashboardStagingPriority7())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.IwoPerObligCaseAverage,
        local.PrevRank.IwoPerObligCaseAverage.GetValueOrDefault()))
      {
  ...
  private void CreateDashboardStagingPriority1()
  {
    ...
    var iwoPerObligCaseAverage =
      local.Contractor.Item.Gcontractor.IwoPerObligCaseAverage.
        GetValueOrDefault();
    var iwoPerObligCaseRnk =
      local.Contractor.Item.Gcontractor.IwoPerObligCaseRnk.GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority2()
  {
    ...
    var param = 0M;
    var iwoPerObligCaseNumerator =
      local.Local1.Item.G.IwoPerObligCaseNumerator.GetValueOrDefault();
    var iwoPerObligCaseDenominator =
      local.Local1.Item.G.IwoPerObligCaseDenominator.GetValueOrDefault();
    var iwoPerObligCaseAverage =
      local.Local1.Item.G.IwoPerObligCaseAverage.GetValueOrDefault();
    var iwoPerObligCaseRnk =
      local.Local1.Item.G.IwoPerObligCaseRnk.GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority3()
  {
    ...
    var param = 0M;
    var iwoPerObligCaseNumerator =
      local.Statewide.IwoPerObligCaseNumerator.GetValueOrDefault();
    var iwoPerObligCaseDenominator =
      local.Statewide.IwoPerObligCaseDenominator.GetValueOrDefault();
    var iwoPerObligCaseAverage =
      local.Statewide.IwoPerObligCaseAverage.GetValueOrDefault();
    var iwoPerObligCaseRnk =
      local.Statewide.IwoPerObligCaseRnk.GetValueOrDefault();
  ...
  private bool ReadLegalActionIncomeSource()
  {
    ...
    return Read("ReadLegalActionIncomeSource",
      ...
      (db, reader) =>
      {
        ...
        entities.LegalActionIncomeSource.Identifier = db.GetInt32(reader, 3);
  ...
  {
    var iwoPerObligCaseDenominator =
      local.Temp.IwoPerObligCaseDenominator.GetValueOrDefault();
    var iwoPerObligCaseAverage =
      local.Temp.IwoPerObligCaseAverage.GetValueOrDefault();
  ...
  {
    var iwoPerObligCaseRnk = local.Temp.IwoPerObligCaseRnk.GetValueOrDefault();
