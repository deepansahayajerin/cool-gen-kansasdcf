...
#region Implementation
  ...
  public void Run()
  {
    ...
    // is a subset of the denominator.  Only include cases that are also
    // counted in the denominator.  Of cases included in the denominator, count
    // those where:
      ...
      foreach(var item in ReadCaseCaseAssignment())
      {
        ...
        foreach(var item1 in ReadCaseRoleCsePersonCaseRoleCsePerson())
        {
          ...
          foreach(var item2 in ReadDebtObligationObligationTypeDebtDetail3())
          {
            ...
            // -----------------------------------------------
            foreach(var item3 in ReadDebtAdjustment3())
            {
              // ------------------------------------------------------------------
            ...
            // --------------------------------------------------------------
            foreach(var item3 in ReadCollection10())
            {
              // --------------------------------------------------------------
...
ReadEach2:
        ...
        local.Statewide.CasesPayingArrearsDenominator =
          local.Statewide.CasesPayingArrearsDenominator.GetValueOrDefault() + 1
          ;
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.CasesPayingArrearsDenominator =
            local.Local1.Item.G.CasesPayingArrearsDenominator.
              GetValueOrDefault() + 1;
        }
        ...
        foreach(var item1 in ReadLegalReferralServiceProvider())
        {
          local.Worker.Assign(local.DashboardAuditData);
...
ReadEach4:
          ...
          foreach(var item1 in ReadCsePerson2())
          {
            ...
            foreach(var item2 in ReadCollection13())
            {
        ...
        local.Statewide.CasesPayingArrearsNumerator =
          local.Statewide.CasesPayingArrearsNumerator.GetValueOrDefault() + 1;
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.CasesPayingArrearsNumerator =
            local.Local1.Item.G.CasesPayingArrearsNumerator.
              GetValueOrDefault() + 1;
        }
...
ReadEach8:
          ...
          foreach(var item1 in ReadCsePerson2())
          {
            ...
            foreach(var item2 in ReadCollection12())
            {
              if (Equal(entities.Collection.CollectionDt,
                local.CollectionDate.Date))
              {
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.Contractor.Item.Gcontractor.ContractorNumber))
        {
          local.Contractor.Update.Gcontractor.CasesPayingArrearsNumerator =
            local.Contractor.Item.Gcontractor.CasesPayingArrearsNumerator.
              GetValueOrDefault() + local
            .Local1.Item.G.CasesPayingArrearsNumerator.GetValueOrDefault();
          local.Contractor.Update.Gcontractor.CasesPayingArrearsDenominator =
            local.Contractor.Item.Gcontractor.CasesPayingArrearsDenominator.
              GetValueOrDefault() + local
            .Local1.Item.G.CasesPayingArrearsDenominator.GetValueOrDefault();
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.Contractor1.Code))
        {
          local.Contractor.Update.Gcontractor.PrvYrCasesPaidArrearsNumtr =
            local.Contractor.Item.Gcontractor.PrvYrCasesPaidArrearsNumtr.
              GetValueOrDefault() + entities
            .PreviousYear.CasesPayingArrearsNumerator.GetValueOrDefault();
          local.Contractor.Update.Gcontractor.PrvYrCasesPaidArrearsDenom =
            local.Contractor.Item.Gcontractor.PrvYrCasesPaidArrearsDenom.
              GetValueOrDefault() + entities
            .PreviousYear.CasesPayingArrearsDenominator.GetValueOrDefault();
...
ReadEach10:
    ...
    foreach(var item in ReadDashboardStagingPriority11())
    {
      ...
      if (local.Temp.CasesPayingArrearsDenominator.GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.Temp.CasesPayingArrearsPercent =
          Math.Round((decimal)local.Temp.CasesPayingArrearsNumerator.
            GetValueOrDefault() /
          local.Temp.CasesPayingArrearsDenominator.GetValueOrDefault(), 3,
      ...
      if (local.Temp.PrvYrCasesPaidArrearsDenom.GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.Temp.CasesPayArrearsPrvYrPct =
          Math.Round((decimal)local.Temp.PrvYrCasesPaidArrearsNumtr.
            GetValueOrDefault() /
          local.Temp.PrvYrCasesPaidArrearsDenom.GetValueOrDefault(), 3,
          MidpointRounding.AwayFromZero);
      }

      // -- Calculate percent change between Current Year Cases Paying Arrears 
      // percent and Previous Year Cases Paying Arrears percent.
      if (local.Temp.CasesPayArrearsPrvYrPct.GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.Temp.PctChgBtwenYrsCasesPayArrs =
          Math.Round((
            local.Temp.CasesPayingArrearsPercent.GetValueOrDefault() - local
          .Temp.CasesPayArrearsPrvYrPct.GetValueOrDefault()) /
          local.Temp.CasesPayArrearsPrvYrPct.GetValueOrDefault(), 3,
          MidpointRounding.AwayFromZero);
      }
    ...
    foreach(var item in ReadDashboardStagingPriority6())
    {
      ...
      // -- Calculate Current Year Cases Paying Arrears percent.
      if (local.DashboardStagingPriority35.CasesPayingArrearsDenominator.
        GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.DashboardStagingPriority35.CasesPayingArrearsPercent =
          Math.Round((decimal)local.DashboardStagingPriority35.
            CasesPayingArrearsNumerator.GetValueOrDefault() /
          local.DashboardStagingPriority35.CasesPayingArrearsDenominator.
            GetValueOrDefault(), 3, MidpointRounding.AwayFromZero);
      }
    ...
    foreach(var item in ReadDashboardStagingPriority8())
    {
      ...
      if (Equal(entities.DashboardStagingPriority35.CasesPayingArrearsPercent,
        local.PreviousRank.CasesPayingArrearsPercent.GetValueOrDefault()))
      {
    ...
    foreach(var item in ReadDashboardStagingPriority13())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.CasesPayingArrearsPercent,
        local.PrevRank.CasesPayingArrearsPercent.GetValueOrDefault()))
      {
  ...
  private void CreateDashboardStagingPriority3()
  {
    ...
    var casesPayingArrearsPercent =
      local.Contractor.Item.Gcontractor.CasesPayingArrearsPercent.
        GetValueOrDefault();
    var casesPayingArrearsRank =
      local.Contractor.Item.Gcontractor.CasesPayingArrearsRank.
        GetValueOrDefault();
    ...
    var casesPayArrearsPrvYrPct =
      local.Contractor.Item.Gcontractor.CasesPayArrearsPrvYrPct.
        GetValueOrDefault();
    var pctChgBtwenYrsCasesPayArrs =
      local.Contractor.Item.Gcontractor.PctChgBtwenYrsCasesPayArrs.
        GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority4()
  {
    ...
    var param = 0M;
    var casesPayingArrearsNumerator =
      local.Local1.Item.G.CasesPayingArrearsNumerator.GetValueOrDefault();
    var casesPayingArrearsDenominator =
      local.Local1.Item.G.CasesPayingArrearsDenominator.GetValueOrDefault();
    var casesPayingArrearsPercent =
      local.Local1.Item.G.CasesPayingArrearsPercent.GetValueOrDefault();
    var casesPayingArrearsRank =
      local.Local1.Item.G.CasesPayingArrearsRank.GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority5()
  {
    ...
    var param = 0M;
    var casesPayingArrearsNumerator =
      local.Statewide.CasesPayingArrearsNumerator.GetValueOrDefault();
    var casesPayingArrearsDenominator =
      local.Statewide.CasesPayingArrearsDenominator.GetValueOrDefault();
    var casesPayingArrearsPercent =
      local.Statewide.CasesPayingArrearsPercent.GetValueOrDefault();
    var casesPayingArrearsRank =
      local.Statewide.CasesPayingArrearsRank.GetValueOrDefault();
  ...
  private IEnumerable<bool> ReadDebtAdjustment3()
  {
    System.Diagnostics.Debug.Assert(entities.Debt.Populated);
    entities.DebtAdjustment.Populated = false;

    return ReadEach("ReadDebtAdjustment3",
      (db, command) =>
      {
        db.SetDateTime(
          command, "createdTmst",
  ...
  {
    var casesPayingArrearsRank =
      local.Temp.CasesPayingArrearsRank.GetValueOrDefault();
  ...
  {
    var casesPayingArrearsPercent =
      local.Temp.CasesPayingArrearsPercent.GetValueOrDefault();
    var prvYrCasesPaidArrearsNumtr =
      local.Temp.PrvYrCasesPaidArrearsNumtr.GetValueOrDefault();
    var prvYrCasesPaidArrearsDenom =
      local.Temp.PrvYrCasesPaidArrearsDenom.GetValueOrDefault();
    var casesPayArrearsPrvYrPct =
      local.Temp.CasesPayArrearsPrvYrPct.GetValueOrDefault();
    var pctChgBtwenYrsCasesPayArrs =
      local.Temp.PctChgBtwenYrsCasesPayArrs.GetValueOrDefault();
