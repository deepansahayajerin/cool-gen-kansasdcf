...
ReadEach1:
    ...
    foreach(var item in ReadCollectionObligationTypeCsePerson())
    {
      ...
      local.Statewide.CollectionsInMonthActual =
        local.Statewide.CollectionsInMonthActual.GetValueOrDefault() + local
...
Test:
      ...
      if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
      {
        ...
        local.Local1.Update.G.CollectionsInMonthActual =
          local.Local1.Item.G.CollectionsInMonthActual.GetValueOrDefault() + local
          .DashboardAuditData.CollectionAmount.GetValueOrDefault();
      }

      // -- Log to the audit table.
      local.DashboardAuditData.DashboardPriority = "1-5" + local
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.Contractor.Item.Gcontractor.ContractorNumber))
        {
          local.Contractor.Update.Gcontractor.CollectionsInMonthActual =
            local.Contractor.Item.Gcontractor.CollectionsInMonthActual.
              GetValueOrDefault() + local
            .Local1.Item.G.CollectionsInMonthActual.GetValueOrDefault();
          local.Contractor.Update.Gcontractor.CollectionsInMonthPriorYear =
            local.Contractor.Item.Gcontractor.CollectionsInMonthPriorYear.
              GetValueOrDefault() + local
            .Local1.Item.G.CollectionsInMonthPriorYear.GetValueOrDefault();
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.Contractor.Item.Gcontractor.ContractorNumber))
        {
          local.Contractor.Update.Gcontractor.CollectionsFfytdPriorYear =
            local.Contractor.Item.Gcontractor.CollectionsFfytdPriorYear.
              GetValueOrDefault() + entities
            .DashboardStagingPriority12.CollectionsFfytdPriorYear.
              GetValueOrDefault();
          local.Contractor.Update.Gcontractor.CollectionsFfytdToPriorMonth =
            local.Contractor.Item.Gcontractor.CollectionsFfytdToPriorMonth.
              GetValueOrDefault() + entities
            .DashboardStagingPriority12.CollectionsFfytdToPriorMonth.
              GetValueOrDefault();
          local.Contractor.Update.Gcontractor.CollectionsInMonthPriorYear =
            local.Contractor.Item.Gcontractor.CollectionsInMonthPriorYear.
              GetValueOrDefault() + entities
            .DashboardStagingPriority12.CollectionsInMonthPriorYear.
              GetValueOrDefault();
          local.Contractor.Update.Gcontractor.CollectionsFfytdActual =
            local.Contractor.Item.Gcontractor.CollectionsFfytdActual.
              GetValueOrDefault() + entities
            .DashboardStagingPriority12.CollectionsFfytdActual.
              GetValueOrDefault();
...
ReadEach2:
    ...
    foreach(var item in ReadDashboardStagingPriority7())
    {
      ...
      if (local.TempDashboardStagingPriority12.CollectionsInMonthPriorYear.
        GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.TempDashboardStagingPriority12.CollectionsInMonthPercentChg =
          Math.Round(
            local.TempDashboardStagingPriority12.CollectionsInMonthActual.
            GetValueOrDefault() / local
          .TempDashboardStagingPriority12.CollectionsInMonthPriorYear.
            GetValueOrDefault() - 1, 3, MidpointRounding.AwayFromZero);
      }

      if (local.TempDashboardStagingPriority12.CollectionsFfytdPriorYear.
        GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.TempDashboardStagingPriority12.CollectionsFfytdPercentChange =
          Math.Round(
            local.TempDashboardStagingPriority12.CollectionsFfytdActual.
            GetValueOrDefault() / local
          .TempDashboardStagingPriority12.CollectionsFfytdPriorYear.
            GetValueOrDefault() - 1, 3, MidpointRounding.AwayFromZero);
      }
    ...
    foreach(var item in ReadDashboardStagingPriority10())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.
        CollectionsInMonthPercentChg,
        local.PrevRank.CollectionsInMonthPercentChg.GetValueOrDefault()))
      {
    ...
    foreach(var item in ReadDashboardStagingPriority8())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.
        ...
        local.PrevRank.CollectionsFfytdPercentChange.GetValueOrDefault()))
      {
        // -- The ranking for this judicial district is tied with the previous 
        // judicial district.
        // -- This JD gets the same ranking already in the local_temp 
  ...
  private void CreateDashboardStagingPriority1()
  {
    ...
    var collectionsFfytdPercentChange =
      local.Contractor.Item.Gcontractor.CollectionsFfytdPercentChange.
        GetValueOrDefault();
    var collectionsFfytdRnk =
      local.Contractor.Item.Gcontractor.CollectionsFfytdRnk.GetValueOrDefault();
    ...
    var collectionsInMonthPercentChg =
      local.Contractor.Item.Gcontractor.CollectionsInMonthPercentChg.
        GetValueOrDefault();
    var collectionsInMonthRnk =
      local.Contractor.Item.Gcontractor.CollectionsInMonthRnk.
        GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority2()
  {
    ...
    var param = 0M;
    var collectionsFfytdToPriorMonth =
      local.Local1.Item.G.CollectionsFfytdToPriorMonth.GetValueOrDefault();
    var collectionsFfytdActual =
      local.Local1.Item.G.CollectionsFfytdActual.GetValueOrDefault();
    var collectionsFfytdPriorYear =
      local.Local1.Item.G.CollectionsFfytdPriorYear.GetValueOrDefault();
    var collectionsFfytdPercentChange =
      local.Local1.Item.G.CollectionsFfytdPercentChange.GetValueOrDefault();
    var collectionsFfytdRnk =
      local.Local1.Item.G.CollectionsFfytdRnk.GetValueOrDefault();
    var collectionsInMonthActual =
      local.Local1.Item.G.CollectionsInMonthActual.GetValueOrDefault();
    var collectionsInMonthPriorYear =
      local.Local1.Item.G.CollectionsInMonthPriorYear.GetValueOrDefault();
    var collectionsInMonthPercentChg =
      local.Local1.Item.G.CollectionsInMonthPercentChg.GetValueOrDefault();
    var collectionsInMonthRnk =
      local.Local1.Item.G.CollectionsInMonthRnk.GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority3()
  {
    ...
    var param = 0M;
    var collectionsFfytdToPriorMonth =
      local.Statewide.CollectionsFfytdToPriorMonth.GetValueOrDefault();
    var collectionsFfytdActual =
      local.Statewide.CollectionsFfytdActual.GetValueOrDefault();
    var collectionsFfytdPriorYear =
      local.Statewide.CollectionsFfytdPriorYear.GetValueOrDefault();
    var collectionsFfytdPercentChange =
      local.Statewide.CollectionsFfytdPercentChange.GetValueOrDefault();
    var collectionsFfytdRnk =
      local.Statewide.CollectionsFfytdRnk.GetValueOrDefault();
    var collectionsInMonthActual =
      local.Statewide.CollectionsInMonthActual.GetValueOrDefault();
    var collectionsInMonthPriorYear =
      local.Statewide.CollectionsInMonthPriorYear.GetValueOrDefault();
    var collectionsInMonthPercentChg =
      local.Statewide.CollectionsInMonthPercentChg.GetValueOrDefault();
    var collectionsInMonthRnk =
      local.Statewide.CollectionsInMonthRnk.GetValueOrDefault();
...
#region Structures
  ...
  public class Local
  {
    ...
    /// </summary>
    [JsonPropertyName("otherDateWorkArea")]
    ...
    /// </summary>
    [JsonPropertyName("otherDashboardStagingPriority12")]
    ...
    /// </summary>
    [JsonPropertyName("tempDashboardStagingPriority12")]
