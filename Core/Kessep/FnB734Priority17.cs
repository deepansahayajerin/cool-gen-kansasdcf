      ...
      local.Period.Count)
    {
        ...
        .Cq66220EffectiveFy.FiscalYear.GetValueOrDefault())
      {
        ...
        foreach(var item in ReadCollection1())
        {
            ...
            switch(local.Period.Count)
            {
              case 1:
                ...
                local.Local1.Update.G.ArrearsDistributedMonthActual =
                  local.Local1.Item.G.ArrearsDistributedMonthActual.
                    GetValueOrDefault() + local
                  .DashboardAuditData.CollectionAmount.GetValueOrDefault();
              ...
              case 2:
                ...
                local.Local1.Update.G.ArrearsDistributedFfytdActual =
                  local.Local1.Item.G.ArrearsDistributedFfytdActual.
                    GetValueOrDefault() + local
                  .DashboardAuditData.CollectionAmount.GetValueOrDefault();
          ...
          local.DashboardAuditData.DashboardPriority = "1-7" + local
      ...
      else
      {
        ...
        foreach(var item in ReadPaymentRequest())
        {
          ...
          foreach(var item1 in ReadCollectionCsePersonCsePersonDisbursementTransaction())
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.Contractor.Item.Gcontractor.ContractorNumber))
        {
          local.Contractor.Update.Gcontractor.ArrearsDistributedFfytdActual =
            local.Contractor.Item.Gcontractor.ArrearsDistributedFfytdActual.
              GetValueOrDefault() + local
            .Local1.Item.G.ArrearsDistributedFfytdActual.GetValueOrDefault();
          local.Contractor.Update.Gcontractor.ArrearsDistributedMonthActual =
            local.Contractor.Item.Gcontractor.ArrearsDistributedMonthActual.
              GetValueOrDefault() + local
            .Local1.Item.G.ArrearsDistributedMonthActual.GetValueOrDefault();
...
Next:
    ...
    foreach(var item in ReadDashboardStagingPriority8())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.
        ...
        local.PrevRank.ArrearsDistributedMonthActual.GetValueOrDefault()))
      {
    ...
    foreach(var item in ReadDashboardStagingPriority6())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.
        ...
        local.PrevRank.ArrearsDistributedFfytdActual.GetValueOrDefault()))
      {
        // -- The ranking for this judicial district is tied with the previous 
        // judicial district.
        // -- This JD gets the same ranking already in the local_temp 
  ...
  private void CreateDashboardStagingPriority1()
  {
    ...
    var arrearsDistributedMonthRnk =
      local.Contractor.Item.Gcontractor.ArrearsDistributedMonthRnk.
        GetValueOrDefault();
    var arrearsDistributedFfytdActual =
      local.Contractor.Item.Gcontractor.ArrearsDistributedFfytdActual.
        GetValueOrDefault();
    var arrearsDistrubutedFfytdRnk =
      local.Contractor.Item.Gcontractor.ArrearsDistrubutedFfytdRnk.
        GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority2()
  {
    ...
    var param = 0M;
    var arrearsDistributedMonthActual =
      local.Local1.Item.G.ArrearsDistributedMonthActual.GetValueOrDefault();
    var arrearsDistributedMonthRnk =
      local.Local1.Item.G.ArrearsDistributedMonthRnk.GetValueOrDefault();
    var arrearsDistributedFfytdActual =
      local.Local1.Item.G.ArrearsDistributedFfytdActual.GetValueOrDefault();
    var arrearsDistrubutedFfytdRnk =
      local.Local1.Item.G.ArrearsDistrubutedFfytdRnk.GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority4()
  {
    ...
    var param = 0M;
    var arrearsDistributedMonthActual =
      local.Statewide.ArrearsDistributedMonthActual.GetValueOrDefault();
    var arrearsDistributedMonthRnk =
      local.Statewide.ArrearsDistributedMonthRnk.GetValueOrDefault();
    var arrearsDistributedFfytdActual =
      local.Statewide.ArrearsDistributedFfytdActual.GetValueOrDefault();
    var arrearsDistrubutedFfytdRnk =
      local.Statewide.ArrearsDistrubutedFfytdRnk.GetValueOrDefault();
  ...
  private IEnumerable<bool> ReadCollection1()
  {
    ...
    return ReadEach("ReadCollection1",
      (db, command) =>
      {
        ...
        db.SetDate(
          command, "date", local.ReportStartDate.Date.GetValueOrDefault());
        db.SetInt32(
  ...
  {
    var arrearsDistributedMonthRnk =
      local.Temp.ArrearsDistributedMonthRnk.GetValueOrDefault();
  ...
  {
    var arrearsDistrubutedFfytdRnk =
      local.Temp.ArrearsDistrubutedFfytdRnk.GetValueOrDefault();
