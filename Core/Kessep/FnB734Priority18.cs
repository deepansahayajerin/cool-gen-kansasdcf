      ...
      foreach(var item1 in ReadCsePersonSupported())
      {
        ...
        foreach(var item2 in ReadDebtObligationObligationTypeDebtDetail3())
        {
          ...
          local.Statewide.ArrearsDueActual =
            local.Statewide.ArrearsDueActual.GetValueOrDefault() + local
          ...
          if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
          {
            ...
            local.Local1.Update.G.ArrearsDueActual =
              local.Local1.Item.G.ArrearsDueActual.GetValueOrDefault() + local
              .DashboardAuditData.DebtBalanceDue.GetValueOrDefault();
          }
        ...
        .Contractor.Count; ++local.Contractor.Index)
      {
          ...
          local.Contractor.Item.Gcontractor.ContractorNumber))
        {
          local.Contractor.Update.Gcontractor.ArrearsDueActual =
            local.Contractor.Item.Gcontractor.ArrearsDueActual.
              GetValueOrDefault() + local
            .Local1.Item.G.ArrearsDueActual.GetValueOrDefault();
...
Next:
    ...
    foreach(var item in ReadDashboardStagingPriority6())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.ArrearsDueActual,
        local.PrevRank.ArrearsDueActual.GetValueOrDefault()))
      {
  ...
  private void CreateDashboardStagingPriority1()
  {
    ...
    var arrearsDueActual =
      local.Contractor.Item.Gcontractor.ArrearsDueActual.GetValueOrDefault();
    var arrearsDueRnk =
      local.Contractor.Item.Gcontractor.ArrearsDueRnk.GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority2()
  {
    ...
    var param = 0M;
    var arrearsDueActual =
      local.Local1.Item.G.ArrearsDueActual.GetValueOrDefault();
    var arrearsDueRnk = local.Local1.Item.G.ArrearsDueRnk.GetValueOrDefault();
  ...
  private void CreateDashboardStagingPriority3()
  {
    ...
    var param = 0M;
    var arrearsDueActual = local.Statewide.ArrearsDueActual.GetValueOrDefault();
    var arrearsDueRnk = local.Statewide.ArrearsDueRnk.GetValueOrDefault();
  ...
  {
    var arrearsDueRnk = local.Temp.ArrearsDueRnk.GetValueOrDefault();
