...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var item in ReadDashboardStagingPriority1())
    {
      ...
      if (local.Temp.CollectionsPerObligCaseDenom.GetValueOrDefault() == 0)
      {
      ...
      else
      {
        local.Temp.CollectionsPerObligCaseAvg =
          Math.Round(
            local.Temp.CollectionsPerObligCaseNumer.GetValueOrDefault() /
          local.Temp.CollectionsPerObligCaseDenom.GetValueOrDefault(), 2,
    ...
    foreach(var item in ReadDashboardStagingPriority2())
    {
      ...
      if (Equal(entities.DashboardStagingPriority12.CollectionsPerObligCaseAvg,
        local.PrevRank.CollectionsPerObligCaseAvg.GetValueOrDefault()))
      {
  ...
  private void UpdateDashboardStagingPriority1()
  {
    ...
    var collectionsPerObligCaseDenom =
      local.Temp.CollectionsPerObligCaseDenom.GetValueOrDefault();
    var collectionsPerObligCaseAvg =
      local.Temp.CollectionsPerObligCaseAvg.GetValueOrDefault();
  ...
  private void UpdateDashboardStagingPriority2()
  {
    var collectionsPerObligCaseRnk =
      local.Temp.CollectionsPerObligCaseRnk.GetValueOrDefault();
