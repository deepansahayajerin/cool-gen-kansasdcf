// Program: FN_B734_PRIORITY_3_12, ID: 945148932, model: 746.
// Short name: SWE03680
using System;
...
/// <summary>
/// <para>
/// A program: FN_B734_PRIORITY_3_12.
/// </para>
/// <para>
...
/// </summary>
[Serializable]
public partial class FnB734Priority312: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B734_PRIORITY_3_12 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB734Priority312(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB734Priority312.
  /// </summary>
  public FnB734Priority312(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    {
      if (Equal(import.ProgramCheckpointRestart.RestartInfo, 81, 4, "3-12"))
      {
      ...
      ; ++local.ReportingPeriod.Index)
    {
          ...
          if (!IsEmpty(import.ProgramCheckpointRestart.RestartInfo))
          {
            ...
            else
            {
              ...
              foreach(var item in ReadDashboardStagingPriority2())
              {
                ...
                local.Local1.Update.G.
                  Assign(entities.DashboardStagingPriority35);
                local.Local1.Update.G.ContemptOrderFilings = 0;
              }
      ...
      foreach(var item in ReadLegalAction())
      {
        ...
        if (!ReadTribunal())
        {
          ...
          local.EabFileHandling.Action = "WRITE";
          local.EabReportSend.RptDetail =
            "Error finding Tribunal for Legal Action.";
          local.EabReportSend.RptDetail =
            TrimEnd(local.EabReportSend.RptDetail) + "  Legal Action ID " + NumberToString
            (import.Persistent.Identifier, 7, 9);
          UseCabErrorReport();
        ...
        local.DashboardAuditData.DashboardPriority = "3-12";
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.ContemptOrderFilings =
            local.Local1.Item.G.ContemptOrderFilings.GetValueOrDefault() + 1;
        }
          ...
          .ProgramCheckpointRestart.UpdateFrequencyCount.GetValueOrDefault())
        {
          ...
          local.ProgramCheckpointRestart.RestartInfo =
            ...
            "3-12    " + " " + local.BatchTimestampWorkArea.TextTimestamp;
          local.ProgramCheckpointRestart.RestartInfo =
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var contemptOrderFilings =
      local.Local1.Item.G.ContemptOrderFilings.GetValueOrDefault();
...
#region Structures
  ...
  public class Import
  {
    ...
    private LegalAction persistent;
