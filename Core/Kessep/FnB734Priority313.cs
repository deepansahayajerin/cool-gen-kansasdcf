  ...
  public void Run()
  {
    ...
    foreach(var item in ReadCollectionObligationTypeCsePerson())
    {
      ...
      if (AsChar(entities.ObligationType.Classification) == 'F')
      {
        ...
        if (ReadFipsTribunal())
        {
          if (entities.Fips.State == 20)
          {
            ...
            local.DashboardAuditData.Office =
              local.Hold.Office.GetValueOrDefault();
      ...
      else
      {
        ...
        local.DashboardAuditData.JudicialDistrict =
          local.Hold.JudicialDistrict ?? "";
        local.DashboardAuditData.Office = local.Hold.Office.GetValueOrDefault();
...
Test:
      ...
      if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
      {
        ...
        switch(TrimEnd(entities.CollectionType.Code))
        {
          case "S":
            local.Local1.Update.G.StypeCollectionAmount =
              local.Local1.Item.G.StypeCollectionAmount.GetValueOrDefault() + local
          ...
          case "F":
            local.Local1.Update.G.FtypeCollectionAmount =
              local.Local1.Item.G.FtypeCollectionAmount.GetValueOrDefault() + local
              .DashboardAuditData.CollectionAmount.GetValueOrDefault();
          ...
          case "I":
            local.Local1.Update.G.ItypeCollectionAmount =
              local.Local1.Item.G.ItypeCollectionAmount.GetValueOrDefault() + local
              .DashboardAuditData.CollectionAmount.GetValueOrDefault();
          ...
          case "U":
            local.Local1.Update.G.UtypeCollectionAmount =
              local.Local1.Item.G.UtypeCollectionAmount.GetValueOrDefault() + local
              .DashboardAuditData.CollectionAmount.GetValueOrDefault();
          ...
          case "C":
            local.Local1.Update.G.CtypeCollectionAmount =
              local.Local1.Item.G.CtypeCollectionAmount.GetValueOrDefault() + local
              .DashboardAuditData.CollectionAmount.GetValueOrDefault();
        ...
        local.Local1.Update.G.TotalCollectionAmount =
          local.Local1.Item.G.TotalCollectionAmount.GetValueOrDefault() + local
          .DashboardAuditData.CollectionAmount.GetValueOrDefault();
      ...
      local.DashboardAuditData.DashboardPriority = "3-13" + local
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var stypeCollectionAmount =
      local.Local1.Item.G.StypeCollectionAmount.GetValueOrDefault();
    var ftypeCollectionAmount =
      local.Local1.Item.G.FtypeCollectionAmount.GetValueOrDefault();
    var itypeCollectionAmount =
      local.Local1.Item.G.ItypeCollectionAmount.GetValueOrDefault();
    var utypeCollectionAmount =
      local.Local1.Item.G.UtypeCollectionAmount.GetValueOrDefault();
    var ctypeCollectionAmount =
      local.Local1.Item.G.CtypeCollectionAmount.GetValueOrDefault();
    var totalCollectionAmount =
      local.Local1.Item.G.TotalCollectionAmount.GetValueOrDefault();
