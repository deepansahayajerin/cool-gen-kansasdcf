...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var item in ReadLegalReferralCase())
    {
      ...
      if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
      {
        ...
        if (local.DashboardAuditData.DaysReported.GetValueOrDefault() >= 60 && local
          .DashboardAuditData.DaysReported.GetValueOrDefault() <= 90)
        {
          local.Local1.Update.G.ReferralAging60To90Days =
            local.Local1.Item.G.ReferralAging60To90Days.GetValueOrDefault() + 1
            ;
        }
        else if (local.DashboardAuditData.DaysReported.GetValueOrDefault() >= 91
          && local.DashboardAuditData.DaysReported.GetValueOrDefault() <= 120)
        {
          local.Local1.Update.G.ReferralAging91To120Days =
            local.Local1.Item.G.ReferralAging91To120Days.GetValueOrDefault() + 1
            ;
        }
        else if (local.DashboardAuditData.DaysReported.GetValueOrDefault() >= 121
          && local.DashboardAuditData.DaysReported.GetValueOrDefault() <= 150)
        {
          local.Local1.Update.G.ReferralAging121To150Days =
            local.Local1.Item.G.ReferralAging121To150Days.GetValueOrDefault() +
            1;
        }
        else if (local.DashboardAuditData.DaysReported.GetValueOrDefault() >= 151
          )
        {
          local.Local1.Update.G.ReferralAging151PlusDays =
            local.Local1.Item.G.ReferralAging151PlusDays.GetValueOrDefault() + 1
            ;
        }
        else
        {
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var referralAging60To90Days =
      local.Local1.Item.G.ReferralAging60To90Days.GetValueOrDefault();
    var referralAging91To120Days =
      local.Local1.Item.G.ReferralAging91To120Days.GetValueOrDefault();
    var referralAging121To150Days =
      local.Local1.Item.G.ReferralAging121To150Days.GetValueOrDefault();
    var referralAging151PlusDays =
      local.Local1.Item.G.ReferralAging151PlusDays.GetValueOrDefault();
