...
#region Implementation
      ...
      if (AsChar(local.CaseUnderOrder.Flag) == 'N')
      {
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.CasesOpenedWithoutOrders =
            local.Local1.Item.G.CasesOpenedWithoutOrders.GetValueOrDefault() + 1
            ;
        }
      ...
      else
      {
        ...
        if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
        {
          ...
          local.Local1.Update.G.CasesOpenedWithOrder =
            local.Local1.Item.G.CasesOpenedWithOrder.GetValueOrDefault() + 1;
        }
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var casesOpenedWithOrder =
      local.Local1.Item.G.CasesOpenedWithOrder.GetValueOrDefault();
    var casesOpenedWithoutOrders =
      local.Local1.Item.G.CasesOpenedWithoutOrders.GetValueOrDefault();
