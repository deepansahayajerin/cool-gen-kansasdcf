...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var item in ReadInfrastructure())
    {
      ...
      local.Case1.Number = entities.Infrastructure.CaseNumber ?? Spaces(10);
      ...
      if (!IsEmpty(local.DashboardAuditData.JudicialDistrict))
      {
        ...
        local.Local1.Update.G.Modifications =
          local.Local1.Item.G.Modifications.GetValueOrDefault() + 1;
      }
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var modifications = local.Local1.Item.G.Modifications.GetValueOrDefault();
