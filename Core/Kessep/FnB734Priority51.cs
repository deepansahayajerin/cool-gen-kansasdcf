...
#region Implementation
    ...
    foreach(var item in ReadCase())
    {
      ...
      if (AsChar(local.CountCase.Flag) == 'Y')
      {
        ...
        local.DashboardStagingPriority35.CaseloadCount =
          local.DashboardStagingPriority35.CaseloadCount.GetValueOrDefault() + 1
          ;
  ...
  private void UpdateDashboardStagingPriority1()
  {
    var asOfDate = local.DashboardStagingPriority35.AsOfDate;
    var caseloadCount =
      entities.DashboardStagingPriority35.CaseloadCount.GetValueOrDefault() + 1;
