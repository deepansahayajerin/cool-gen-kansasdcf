// Program: FN_B734_PRIORITY_5_12, ID: 945148972, model: 746.
// Short name: SWE03717
using System;
...
/// <summary>
/// <para>
/// A program: FN_B734_PRIORITY_5_12.
/// </para>
/// <para>
...
/// </summary>
[Serializable]
public partial class FnB734Priority512: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B734_PRIORITY_5_12 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB734Priority512(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB734Priority512.
  /// </summary>
  public FnB734Priority512(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    {
      if (Equal(import.ProgramCheckpointRestart.RestartInfo, 81, 4, "5-12"))
      {
...
Test:
      ...
      ; ++local.ReportingPeriod.Index)
    {
      ...
      foreach(var item in ReadLegalAction())
      {
        ...
        local.DashboardAuditData.DashboardPriority = "5-12";
        local.DashboardAuditData.StandardNumber =
          entities.LegalAction.StandardNumber;
        local.DashboardAuditData.LegalActionDate =
          entities.LegalAction.FiledDate;
          ...
          .ProgramCheckpointRestart.UpdateFrequencyCount.GetValueOrDefault())
        {
          ...
          local.ProgramCheckpointRestart.RestartInfo =
            ...
            "5-12    " + " " + local.BatchTimestampWorkArea.TextTimestamp;
          local.ProgramCheckpointRestart.RestartInfo =
    ...
    return ReadEach("ReadLegalAction",
      (db, command) =>
      {
        ...
        db.SetDateTime(
          ...
          local.CheckpointLegalAction.CreatedTstamp.GetValueOrDefault());
      },
      (db, reader) =>
      {
...
#region Structures
  ...
  public class Local
  {
    ...
    /// </summary>
    [JsonPropertyName("checkpointLegalAction")]
    ...
    /// </summary>
    [JsonPropertyName("checkpointLegalReferral")]
