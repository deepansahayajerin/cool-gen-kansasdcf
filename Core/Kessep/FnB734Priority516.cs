      ...
      foreach(var item in ReadLegalActionServiceProcess())
      {
        ...
        foreach(var item1 in ReadLegalReferralCase())
        {
            ...
            (entities.LegalReferral.ReferralReason4, "EST"))
          {
            ...
            if (local.DashboardStagingPriority35.DaysToReturnOfServiceDenom.
              GetValueOrDefault() <= 0 || local
              .DashboardStagingPriority35.DaysToReturnOfSrvcNumer.
                GetValueOrDefault() <= 0)
            {
            ...
            else
            {
              local.DashboardStagingPriority35.DaysToReturnOfServiceAvg =
                (decimal)local.DashboardStagingPriority35.
                  DaysToReturnOfSrvcNumer.GetValueOrDefault() / local
                .DashboardStagingPriority35.DaysToReturnOfServiceDenom.
                  GetValueOrDefault();
            }
          ...
          .ProgramCheckpointRestart.UpdateFrequencyCount.GetValueOrDefault())
        {
          ...
          local.ProgramCheckpointRestart.RestartInfo =
            ...
            "5-16    " + " " + local.BatchTimestampWorkArea.TextTimestamp;
          local.ProgramCheckpointRestart.RestartInfo =
