...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var item in ReadCsePersonAddressCsePersonCase())
    {
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var ncpLocatesByAddress =
      local.DashboardStagingPriority35.NcpLocatesByAddress.GetValueOrDefault();
  ...
  private IEnumerable<bool> ReadCsePersonAddressCsePersonCase()
  {
    ...
    return ReadEach("ReadCsePersonAddressCsePersonCase",
      (db, command) =>
      {
        db.SetDate(
    ...
    return Read("ReadServiceProviderOfficeServiceProvider",
      (db, command) =>
      {
        ...
        db.SetDate(
          ...
          entities.CsePersonAddress.VerifiedDate.GetValueOrDefault());
      },
      (db, reader) =>
      {
