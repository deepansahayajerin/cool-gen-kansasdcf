// Program: FN_B734_PRIORITY_5_21, ID: 945148977, model: 746.
// Short name: SWE03711
using System;
...
/// <summary>
/// <para>
/// A program: FN_B734_PRIORITY_5_21.
/// </para>
/// <para>
...
/// </summary>
[Serializable]
public partial class FnB734Priority521: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B734_PRIORITY_5_21 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB734Priority521(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB734Priority521.
  /// </summary>
  public FnB734Priority521(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    {
      if (Equal(import.ProgramCheckpointRestart.RestartInfo, 81, 4, "5-21"))
      {
    ...
    foreach(var item in ReadLegalReferralCase())
    {
        ...
        (entities.LegalReferral.ReferralReason4, "EST"))
      {
        ...
        local.DashboardAuditData.DashboardPriority = "5-21";
        local.CountCase.Flag = "Y";
        local.DashboardAuditData.WorkerId =
          local.DashboardStagingPriority35.ReportLevelId;
        local.DashboardStagingPriority35.ReferralsToLegalForEst =
          local.DashboardStagingPriority35.ReferralsToLegalForEst.
            GetValueOrDefault() + 1;
      }
      else
  ...
  private bool ReadServiceProviderCaseAssignment()
  {
    ...
    return Read("ReadServiceProviderCaseAssignment",
      (db, command) =>
      {
        ...
        db.SetDateTime(
          command, "createdTimestamp",
          entities.LegalReferral.CreatedTimestamp.GetValueOrDefault());
      },
      (db, reader) =>
      {
  ...
  private void UpdateDashboardStagingPriority2()
  {
    ...
    Update("UpdateDashboardStagingPriority2",
      (db, command) =>
      {
        db.SetNullableInt32(command, "estRefToLegal", 0);
        db.SetInt32(
          command, "reportMonth",
          entities.DashboardStagingPriority35.ReportMonth);
        db.SetString(
    ...
    entities.DashboardStagingPriority35.ReferralsToLegalForEst = 0;
    entities.DashboardStagingPriority35.Populated = true;
  }
#endregion
