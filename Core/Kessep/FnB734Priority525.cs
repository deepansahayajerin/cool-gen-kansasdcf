// Program: FN_B734_PRIORITY_5_25, ID: 1902564404, model: 746.
// Short name: SWE03756
using System;
...
/// <summary>
/// <para>
/// A program: FN_B734_PRIORITY_5_25.
/// </para>
/// <para>
...
/// </summary>
[Serializable]
public partial class FnB734Priority525: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B734_PRIORITY_5_25 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB734Priority525(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB734Priority525.
  /// </summary>
  public FnB734Priority525(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    {
      if (Equal(import.ProgramCheckpointRestart.RestartInfo, 81, 4, "5-25"))
      {
...
Test:
      ...
      ; ++local.ReportingPeriod.Index)
    {
      ...
      foreach(var item in ReadLegalAction())
      {
        ...
        local.DashboardStagingPriority35.ContemptMotionFilings =
          local.DashboardStagingPriority35.ContemptMotionFilings.
            GetValueOrDefault() + 1;
        local.DashboardAuditData.DashboardPriority = "5-25";
          ...
          .ProgramCheckpointRestart.UpdateFrequencyCount.GetValueOrDefault())
        {
          ...
          local.ProgramCheckpointRestart.RestartInfo =
            ...
            "5-11    " + " " + local.BatchTimestampWorkArea.TextTimestamp;
          local.ProgramCheckpointRestart.RestartInfo =
    ...
    local.ProgramCheckpointRestart.RestartInfo = "";
    local.ProgramCheckpointRestart.RestartInfo =
      Substring(import.ProgramCheckpointRestart.RestartInfo, 250, 1, 80) + "5-26     ";
