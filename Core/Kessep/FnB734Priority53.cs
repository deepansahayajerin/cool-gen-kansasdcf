...
Test:
      ...
      ; ++local.ReportingPeriod.Index)
    {
      ...
      foreach(var item in ReadLegalAction2())
      {
        ...
        foreach(var item1 in ReadCsePersonCsePersonCaseServiceProvider())
        {
        ...
        foreach(var item1 in ReadLegalActionAssigmentServiceProvider())
        {
          ...
          .ProgramCheckpointRestart.UpdateFrequencyCount.GetValueOrDefault())
        {
          ...
          local.ProgramCheckpointRestart.RestartInfo =
            ...
            "5-03     " + entities.LegalAction.StandardNumber + local
            .LegalAction.Text10;
          local.ProgramCheckpointRestart.RestartInfo =
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var newOrdersEstablished =
      local.DashboardStagingPriority35.NewOrdersEstablished.GetValueOrDefault();
  ...
  private IEnumerable<bool> ReadCsePersonCsePersonCaseServiceProvider()
  {
    ...
    return ReadEach("ReadCsePersonCsePersonCaseServiceProvider",
      ...
      {
        db.SetNullableDate(
          command, "endDate", local.End.Date.GetValueOrDefault());
        db.SetNullableDate(
          command, "startDate",
