// Program: FN_B734_PRIORITY_5_5, ID: 945148968, model: 746.
// Short name: SWE03715
using System;
...
/// <summary>
/// <para>
/// A program: FN_B734_PRIORITY_5_5.
/// </para>
/// <para>
...
/// </summary>
[Serializable]
public partial class FnB734Priority55: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B734_PRIORITY_5_5 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB734Priority55(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB734Priority55.
  /// </summary>
  public FnB734Priority55(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // A count of all cases that opened within the report month.
    // Report Level: Caseworker
    // Report Period: Month
    // 1)	Count only cases that opened within the report period.
    // 2)	Count each case only once.
    // 3)	Count caseworker assigned to the case as of refresh date.
    // -------------------------------------------------------------------------------------
    ...
    {
      if (Equal(import.ProgramCheckpointRestart.RestartInfo, 81, 4, "5-05"))
      {
    ...
    foreach(var item in ReadCase())
    {
      ...
      if (AsChar(entities.Case1.Status) == 'C')
      {
        ...
        {
          // WAS NOT REOPEND DURING THE PERIOD
          continue;
        }
      }
      ...
      local.DashboardStagingPriority35.CasesOpened = 1;
      local.DashboardAuditData.DashboardPriority = "5-5";
    ...
    local.ProgramCheckpointRestart.RestartInfo = "";
    local.ProgramCheckpointRestart.RestartInfo =
      Substring(import.ProgramCheckpointRestart.RestartInfo, 250, 1, 80) + "5-09    ";
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var casesOpened =
      local.DashboardStagingPriority35.CasesOpened.GetValueOrDefault();
    ...
    entities.DashboardStagingPriority35.CasesOpened = casesOpened;
  ...
  private void UpdateDashboardStagingPriority1()
  {
    var asOfDate = local.DashboardStagingPriority35.AsOfDate;
    var casesOpened =
      entities.DashboardStagingPriority35.CasesOpened.GetValueOrDefault() + 1;
  ...
  private void UpdateDashboardStagingPriority2()
  {
    ...
    Update("UpdateDashboardStagingPriority2",
      (db, command) =>
      {
        db.SetNullableInt32(command, "casesOpened", 0);
        db.SetInt32(
          command, "reportMonth",
          entities.DashboardStagingPriority35.ReportMonth);
        db.SetString(
    ...
    entities.DashboardStagingPriority35.CasesOpened = 0;
    entities.DashboardStagingPriority35.Populated = true;
  }
#endregion
