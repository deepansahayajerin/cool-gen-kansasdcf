// Program: FN_B734_PRIORITY_5_9, ID: 945148969, model: 746.
// Short name: SWE03716
using System;
...
/// <summary>
/// <para>
/// A program: FN_B734_PRIORITY_5_9.
/// </para>
/// <para>
...
/// </summary>
[Serializable]
public partial class FnB734Priority59: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B734_PRIORITY_5_9 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB734Priority59(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB734Priority59.
  /// </summary>
  public FnB734Priority59(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    {
      if (Equal(import.ProgramCheckpointRestart.RestartInfo, 81, 3, "5-9"))
      {
    ...
    foreach(var item in ReadInfrastructure())
    {
      ...
      local.DashboardStagingPriority35.Modifications =
        local.DashboardStagingPriority35.Modifications.GetValueOrDefault() + 1;
      local.DashboardAuditData.WorkerId =
        local.DashboardStagingPriority35.ReportLevelId;
      local.DashboardAuditData.DashboardPriority = "5-9";
    ...
    local.ProgramCheckpointRestart.RestartInfo = "";
    local.ProgramCheckpointRestart.RestartInfo =
      Substring(import.ProgramCheckpointRestart.RestartInfo, 250, 1, 80) + "5-10    ";
  ...
  private void CreateDashboardStagingPriority35()
  {
    ...
    var param = 0M;
    var modifications =
      local.DashboardStagingPriority35.Modifications.GetValueOrDefault();
  ...
  private void UpdateDashboardStagingPriority1()
  {
    var asOfDate = local.DashboardStagingPriority35.AsOfDate;
    var modifications =
      entities.DashboardStagingPriority35.Modifications.GetValueOrDefault() + 1;
  ...
  private void UpdateDashboardStagingPriority2()
  {
    ...
    Update("UpdateDashboardStagingPriority2",
      (db, command) =>
      {
        db.SetNullableInt32(command, "modifications", 0);
        db.SetInt32(
          command, "reportMonth",
          entities.DashboardStagingPriority35.ReportMonth);
        db.SetString(
    ...
    entities.DashboardStagingPriority35.Modifications = 0;
    entities.DashboardStagingPriority35.Populated = true;
  }
#endregion
