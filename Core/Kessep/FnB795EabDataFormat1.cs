// Program: FN_B795_EAB_DATA_FORMAT_1, ID: 1902457489, model: 746.
// Short name: SWEXEW22
using System;
...
/// <summary>
/// A program: FN_B795_EAB_DATA_FORMAT_1.
/// </summary>
[Serializable]
public partial class FnB795EabDataFormat1: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_B795_EAB_DATA_FORMAT_1 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnB795EabDataFormat1(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnB795EabDataFormat1.
  /// </summary>
  public FnB795EabDataFormat1(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXEW22", context, import, export, EabOptions.Hpvp);
  }
#endregion
