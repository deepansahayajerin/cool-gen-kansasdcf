// Program: FN_BF12_HOUSEKEEPING, ID: 373334436, model: 746.
// Short name: SWE02726
using System;
...
/// <summary>
/// A program: FN_BF12_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class FnBf12Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_BF12_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnBf12Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnBf12Housekeeping.
  /// </summary>
  public FnBf12Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  {
    // ***************************************************
    // 2001-02-26  WR 000235  Fangman - New AB for Psum Redesign Conversion.
    // ***************************************************
    // ***** Get the run parameters for this program.
    export.ProgramProcessingInfo.Name = "SWEFBF12";
    ...
    {
      local.EabReportSend.RptDetail =
        "Severe Error:  User_ID should be set to SWEFBF12 instead of " + global
