// Program: FN_BF13_HOUSEKEEPING, ID: 373374936, model: 746.
// Short name: SWE02733
using System;
...
/// <summary>
/// A program: FN_BF13_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class FnBf13Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_BF13_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnBf13Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnBf13Housekeeping.
  /// </summary>
  public FnBf13Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  {
    // ***************************************************
    // 2001-06-04  WR 010504  Fangman - New AB for Collection Conversion.
    // ***************************************************
    // ***** Get the run parameters for this program.
    export.ProgramProcessingInfo.Name = "SWEFBF13";
    ...
    {
      local.EabReportSend.RptDetail =
        "Processing Collections for Obligees between: " + export
    ...
    {
      local.EabReportSend.RptDetail =
        "Severe Error:  User_ID should be set to SWEFBF13 instead of " + global
