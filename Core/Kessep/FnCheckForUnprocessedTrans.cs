// Program: FN_CHECK_FOR_UNPROCESSED_TRANS, ID: 372289057, model: 746.
// Short name: SWE02259
using System;
...
/// <summary>
/// A program: FN_CHECK_FOR_UNPROCESSED_TRANS.
/// </summary>
[Serializable]
public partial class FnCheckForUnprocessedTrans: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_CHECK_FOR_UNPROCESSED_TRANS program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnCheckForUnprocessedTrans(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnCheckForUnprocessedTrans.
  /// </summary>
  public FnCheckForUnprocessedTrans(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
