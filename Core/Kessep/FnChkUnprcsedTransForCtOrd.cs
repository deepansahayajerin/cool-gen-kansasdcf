// Program: FN_CHK_UNPRCSED_TRANS_FOR_CT_ORD, ID: 370993501, model: 746.
// Short name: SWE00358
using System;
...
/// <summary>
/// A program: FN_CHK_UNPRCSED_TRANS_FOR_CT_ORD.
/// </summary>
[Serializable]
public partial class FnChkUnprcsedTransForCtOrd: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_CHK_UNPRCSED_TRANS_FOR_CT_ORD program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnChkUnprcsedTransForCtOrd(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnChkUnprcsedTransForCtOrd.
  /// </summary>
  public FnChkUnprcsedTransForCtOrd(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
    ...
    return ReadEach("ReadCashReceiptDetailCashReceiptDetailStatus",
      (db, command) =>
      {
        db.SetNullableString(
          command, "courtOrderNumber", import.ByStdNum.StandardNumber ?? "");
      },
      (db, reader) =>
      {
  ...
  private bool ReadCollection()
  {
    ...
    return Read("ReadCollection",
      (db, command) =>
      {
        ...
        db.SetNullableString(
          command, "standardNo", import.ByStdNum.StandardNumber ?? "");
      },
      (db, reader) =>
      {
...
#region Structures
  ...
  public class Import
  {
    ...
    /// A value of ByStdNum.
    /// </summary>
    [JsonPropertyName("byStdNum")]
    public LegalAction ByStdNum
    {
      get => byStdNum ??= new();
      set => byStdNum = value;
    }
