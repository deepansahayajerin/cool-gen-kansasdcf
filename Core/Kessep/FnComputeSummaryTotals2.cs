// Program: FN_COMPUTE_SUMMARY_TOTALS_2, ID: 1902558079, model: 746.
// Short name: SWE03760
using System;
...
/// <summary>
/// A program: FN_COMPUTE_SUMMARY_TOTALS_2.
/// </summary>
[Serializable]
public partial class FnComputeSummaryTotals2: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_COMPUTE_SUMMARY_TOTALS_2 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnComputeSummaryTotals2(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnComputeSummaryTotals2.
  /// </summary>
  public FnComputeSummaryTotals2(IContext context, Import import, Export export):
...
#region Implementation
    ...
    foreach(var item in ReadObligationObligationTypeDebtDetail())
    {
        ...
        (local.HardcodedAccruingClass.Classification))
      {
        if (entities.ObligationType.SystemGeneratedIdentifier == local
          .McObligation.SystemGeneratedIdentifier)
        {
          continue;
        }
  ...
  private void UseFnHardcodedDebtDistribution()
  {
    ...
    local.McObligation.SystemGeneratedIdentifier =
...
#region Structures
  ...
  {
    /// <summary>
    /// A value of McObligation.
    /// </summary>
    [JsonPropertyName("mcObligation")]
    public ObligationType McObligation
    {
      get => mcObligation ??= new();
      set => mcObligation = value;
    }
    ...
    private ObligationType mcObligation;
