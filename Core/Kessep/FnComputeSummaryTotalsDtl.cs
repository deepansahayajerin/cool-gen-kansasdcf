// Program: FN_COMPUTE_SUMMARY_TOTALS_DTL, ID: 372442608, model: 746.
// Short name: SWE02323
using System;
...
/// <summary>
/// A program: FN_COMPUTE_SUMMARY_TOTALS_DTL.
/// </summary>
[Serializable]
public partial class FnComputeSummaryTotalsDtl: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_COMPUTE_SUMMARY_TOTALS_DTL program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnComputeSummaryTotalsDtl(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnComputeSummaryTotalsDtl.
  /// </summary>
  public FnComputeSummaryTotalsDtl(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
