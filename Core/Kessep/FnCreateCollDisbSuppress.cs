// Program: FN_CREATE_COLL_DISB_SUPPRESS, ID: 371751820, model: 746.
// Short name: SWE00353
using System;
...
/// <summary>
/// <para>
/// A program: FN_CREATE_COLL_DISB_SUPPRESS.
/// </para>
/// <para>
/// RESP: Finance
/// This cab will create a collection disbursement suppression.
/// </para>
/// </summary>
[Serializable]
public partial class FnCreateCollDisbSuppress: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_CREATE_COLL_DISB_SUPPRESS program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnCreateCollDisbSuppress(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnCreateCollDisbSuppress.
  /// </summary>
  public FnCreateCollDisbSuppress(IContext context, Import import, Export export)
    :
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    //                   D. M. Nilsen  09/06/95
    // 07/29/97  Paul R. Egger - MTW   Add create for CSE_Person_Account, if it 
    // doesn't exist.
    // *******************************************************************
    // ******************************************************************
