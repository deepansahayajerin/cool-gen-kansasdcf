// Program: FN_DETERMINE_PGM_FOR_DBT_DTL_2, ID: 374422422, model: 746.
// Short name: SWE01483
using System;
...
/// <summary>
/// A program: FN_DETERMINE_PGM_FOR_DBT_DTL_2.
/// </summary>
[Serializable]
public partial class FnDeterminePgmForDbtDtl2: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_DETERMINE_PGM_FOR_DBT_DTL_2 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnDeterminePgmForDbtDtl2(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnDeterminePgmForDbtDtl2.
  /// </summary>
  public FnDeterminePgmForDbtDtl2(IContext context, Import import, Export export)
    :
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    //  Madhu Kumar        Initial Code       05/22/00
    ...
    {
      local.Collection.Date = local.CurrentDate.Date;
    }
    else
    {
    ...
    {
      local.DprProgram.ProgramState = export.DprProgram.ProgramState;
      UseFnDeterminePgmUsingMatrix2();
    }
    else
    {
      if (ReadProgram1())
...
Test:
    ...
    {
      if (local.HoldKeyOnly.SystemGeneratedIdentifier == local
  ...
  private void UseFnDeterminePgmUsingMatrix2()
  {
    var useImport = new FnDeterminePgmUsingMatrix2.Import();
    var useExport = new FnDeterminePgmUsingMatrix2.Export();
    ...
    Call(FnDeterminePgmUsingMatrix2.Execute, useImport, useExport);
  ...
  private void UseFnDetermineProgramState1()
  {
  ...
  private void UseFnDetermineProgramState2()
  {
    var useImport = new FnDetermineProgramState.Import();
    var useExport = new FnDetermineProgramState.Export();

    useImport.KeyOnly.SystemGeneratedIdentifier =
      export.Program.SystemGeneratedIdentifier;
