// Program: FN_EAB_GENERATE_RPT220_FILE, ID: 372799596, model: 746.
// Short name: SWEXF220
using System;
...
/// <summary>
/// <para>
/// A program: FN_EAB_GENERATE_RPT220_FILE.
/// </para>
/// <para>
/// This external generates a file to be sorted, and then used in generating the
/// Manual coupon and obligation suppression report.
/// </para>
/// </summary>
[Serializable]
public partial class FnEabGenerateRpt220File: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_EAB_GENERATE_RPT220_FILE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnEabGenerateRpt220File(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnEabGenerateRpt220File.
  /// </summary>
  public FnEabGenerateRpt220File(IContext context, Import import, Export export):
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXF220", context, import, export, EabOptions.Hpvp);
  }
#endregion
