// Program: FN_SWEFR001_DUP_PMT_RPT, ID: 372954354, model: 746.
// Short name: SWEF001R
using System;
...
/// <summary>
/// A program: FN_SWEFR001_DUP_PMT_RPT.
/// </summary>
[Serializable]
[ProcedureStep(ProcedureType.Batch)]
public partial class FnSwefr001DupPmtRpt: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the FN_SWEFR001_DUP_PMT_RPT program.
  /// </summary>
  [Entry]
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new FnSwefr001DupPmtRpt(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of FnSwefr001DupPmtRpt.
  /// </summary>
  public FnSwefr001DupPmtRpt(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    foreach(var item in ReadDisbursementCsePerson())
    {
      ...
      foreach(var item1 in ReadDisbursementCsePersonDisbursementType())
      {
        ...
        if (!Equal(entities.Obligee1.Number, local.HoldCsePerson.Number))
        {
          ...
          {
            local.PotRcvTxt.Text8 =
              NumberToString((long)local.PotRecForAr.TotalCurrency, 11, 5) + "."
              + NumberToString
    ...
    {
      local.PotRcvTxt.Text8 =
        NumberToString((long)local.PotRecForAr.TotalCurrency, 11, 5) + "." + NumberToString
        ((long)(local.PotRecForAr.TotalCurrency * 100), 14, 2);
      local.EabReportSend.RptDetail =
        "                                                                      " +
        local.PotRcvTxt.Text8;
