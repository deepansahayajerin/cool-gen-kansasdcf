// Program: LE_B595_HOUSEKEEPING, ID: 374349323, model: 746.
// Short name: SWE02526
using System;
...
/// <summary>
/// A program: LE_B595_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class LeB595Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the LE_B595_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new LeB595Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of LeB595Housekeeping.
  /// </summary>
  public LeB595Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // --------------------------------------------------------------
    local.ProgramProcessingInfo.Name = "SWELB595";
    ...
    export.EabReportSend.ReportNumber = 1;
    ...
    if (!IsEmpty(local.ProgramProcessingInfo.ParameterList))
    {
      ...
      local.Position.Count =
        Find(local.ProgramProcessingInfo.ParameterList, "RUN_TYPE=MASTER");

      if (local.Position.Count > 0)
      {
        export.EabReportSend.ReportNumber = 2;
      }
    }
    ...
    if (ReadPgmNameTable())
    {
      local.EabReportSend.RptHeading3 = "            " + TrimEnd
        (entities.PgmNameTable.PgmDescription) + " - DATA REPORT";
    }
    else
    {
      local.EabReportSend.RptHeading3 =
        "            Program Name not in PGM NAME TABLE - DATA REPORT";
    }
    ...
    if (ReadFips())
    {
      export.Kansas.State = entities.Fips.State;
    }
  }
  ...
  private void UseLeEabReadFipsUpdate()
  {
    ...
    useImport.EabFileHandling.Action = local.EabFileHandling.Action;
    useImport.EabReportSend.ReportNumber = export.EabReportSend.ReportNumber;
