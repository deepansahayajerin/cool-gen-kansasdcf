// Program: LE_EAB_READ_B576_FILE_EXTRACT, ID: 371411823, model: 746.
// Short name: SWEXLR02
using System;
...
/// <summary>
/// A program: LE_EAB_READ_B576_FILE_EXTRACT.
/// </summary>
[Serializable]
public partial class LeEabReadB576FileExtract: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the LE_EAB_READ_B576_FILE_EXTRACT program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new LeEabReadB576FileExtract(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of LeEabReadB576FileExtract.
  /// </summary>
  public LeEabReadB576FileExtract(IContext context, Import import, Export export)
    :
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXLR02", context, import, export, EabOptions.Hpvp);
  }
#endregion
