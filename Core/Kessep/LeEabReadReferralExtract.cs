// Program: LE_EAB_READ_REFERRAL_EXTRACT, ID: 373430168, model: 746.
// Short name: SWEXLE08
using System;
...
/// <summary>
/// A program: LE_EAB_READ_REFERRAL_EXTRACT.
/// </summary>
[Serializable]
public partial class LeEabReadReferralExtract: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the LE_EAB_READ_REFERRAL_EXTRACT program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new LeEabReadReferralExtract(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of LeEabReadReferralExtract.
  /// </summary>
  public LeEabReadReferralExtract(IContext context, Import import, Export export)
    :
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXLE08", context, import, export, EabOptions.Hpvp);
  }
#endregion
