// Program: OE_B413_HOUSEKEEPING, ID: 373414678, model: 746.
// Short name: SWE01962
using System;
...
/// <summary>
/// A program: OE_B413_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class OeB413Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B413_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB413Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB413Housekeeping.
  /// </summary>
  public OeB413Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    export.ProgramProcessingInfo.Name = "SWEEB413";
    ...
    if (!IsEmpty(local.Eab.TextReturnCode))
    {
      local.EabFileHandling.Action = "WRITE";
      local.EabReportSend.RptDetail =
        "Error encountered opening external file.";
      UseCabErrorReport1();
      ExitState = "ACO_NN0000_ABEND_FOR_BATCH";
    ...
    if (ReadCode())
    {
      MoveCode(entities.Code, export.Csi);
    }
    else
    {
      local.EabFileHandling.Action = "WRITE";
      local.EabReportSend.RptDetail =
        "Error - Code table for CSENet CSI Ready Indicator does not exist.";
      UseCabErrorReport1();
      ExitState = "ACO_NN0000_ABEND_FOR_BATCH";
    }
  }
