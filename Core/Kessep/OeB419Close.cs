// Program: OE_B419_CLOSE, ID: 374569358, model: 746.
// Short name: SWE00118
using System;
...
/// <summary>
/// A program: OE_B419_CLOSE.
/// </summary>
[Serializable]
public partial class OeB419Close: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B419_CLOSE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB419Close(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB419Close.
  /// </summary>
  public OeB419Close(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    if (!IsEmpty(local.ExternalFileStatus.TextReturnCode))
    {
      local.EabFileHandling.Action = "WRITE";
      local.EabReportSend.RptDetail =
        "Error encountered while closing external file FCR_EXTRACT";
      UseCabErrorReport1();
