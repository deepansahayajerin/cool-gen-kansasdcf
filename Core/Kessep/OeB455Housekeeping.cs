// Program: OE_B455_HOUSEKEEPING, ID: 371365684, model: 746.
// Short name: SWE03600
using System;
...
/// <summary>
/// A program: OE_B455_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class OeB455Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B455_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB455Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB455Housekeeping.
  /// </summary>
  public OeB455Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // ***********************************************
    local.ProgramProcessingInfo.Name = "SWEEB455";
  ...
  private void UseOeEabRequestToKdor()
  {
