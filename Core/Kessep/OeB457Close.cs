// Program: OE_B457_CLOSE, ID: 371380931, model: 746.
// Short name: SWE03607
using System;
...
/// <summary>
/// A program: OE_B457_CLOSE.
/// </summary>
[Serializable]
public partial class OeB457Close: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B457_CLOSE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB457Close(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB457Close.
  /// </summary>
  public OeB457Close(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
  ...
  public void Run()
  {
    ...
    do
    {
      switch(local.Sub.Count)
      {
        ...
        case 4:
          local.EabReportSend.RptDetail =
            "Total number of courtesy letters created   :" + NumberToString
