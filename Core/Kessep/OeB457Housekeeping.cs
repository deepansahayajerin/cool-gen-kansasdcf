// Program: OE_B457_HOUSEKEEPING, ID: 371380921, model: 746.
// Short name: SWE03605
using System;
...
/// <summary>
/// A program: OE_B457_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class OeB457Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B457_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB457Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB457Housekeeping.
  /// </summary>
  public OeB457Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // ***********************************************
    local.ProgramProcessingInfo.Name = "SWEEB457";
