// Program: OE_B458_HOUSEKEEPING, ID: 371384676, model: 746.
// Short name: SWE03611
using System;
...
/// <summary>
/// A program: OE_B458_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class OeB458Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B458_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB458Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB458Housekeeping.
  /// </summary>
  public OeB458Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // ***********************************************
    local.ProgramProcessingInfo.Name = "SWEEB458";
