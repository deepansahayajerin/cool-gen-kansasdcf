// Program: OE_B494_CLOSING, ID: 372971318, model: 746.
// Short name: SWE02478
using System;
...
/// <summary>
/// A program: OE_B494_CLOSING.
/// </summary>
[Serializable]
public partial class OeB494Closing: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B494_CLOSING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB494Closing(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB494Closing.
  /// </summary>
  public OeB494Closing(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  private void UseEabWriteMedicalSupportChange()
  {
    ...
    useImport.TrailerRecord.Count = import.RecordCount.Count;
    useImport.EabFileHandling.Action = local.EabFileHandling.Action;
    MoveDateWorkArea(local.Current, useImport.Trailer);
