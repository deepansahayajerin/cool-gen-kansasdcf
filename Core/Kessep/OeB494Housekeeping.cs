// Program: OE_B494_HOUSEKEEPING, ID: 372976136, model: 746.
// Short name: SWE02479
using System;
...
/// <summary>
/// A program: OE_B494_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class OeB494Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B494_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB494Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB494Housekeeping.
  /// </summary>
  public OeB494Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // **********************************************************
    local.ProgramProcessingInfo.Name = "SWEEB494";
    ...
    if (Equal(entities.ProgramProcessingInfo.ParameterList, "M"))
    {
      local.NeededToOpen.RptHeading3 = "             MEDICAL SUPPORT ORDERS" + " " +
        export.ReportingMonthYear.Text30;
    }
    else
    {
      local.NeededToOpen.RptHeading3 = "     MEDICAL SUPPORT ORDERS " + export
    ...
    local.NeededToOpen.ColHeading1 =
      "                        ABSENT PARENT                     APPLICANT RECIPIENT";
  ...
  private void UseCabSetMaximumDiscontinueDate()
  {
    ...
    export.Max.Date = useExport.DateWorkArea.Date;
  }
