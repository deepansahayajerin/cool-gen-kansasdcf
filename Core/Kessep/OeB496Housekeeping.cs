// Program: OE_B496_HOUSEKEEPING, ID: 371173808, model: 746.
// Short name: SWE02638
using System;
...
/// <summary>
/// A program: OE_B496_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class OeB496Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B496_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB496Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB496Housekeeping.
  /// </summary>
  public OeB496Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    export.ProgramProcessingInfo.Name = "SWEEB496";
    ...
    export.Start.Date = new DateTime(1998, 9, 6);
