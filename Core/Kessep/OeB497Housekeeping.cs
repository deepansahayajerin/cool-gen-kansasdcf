// Program: OE_B497_HOUSEKEEPING, ID: 371178000, model: 746.
// Short name: SWE01975
using System;
...
/// <summary>
/// A program: OE_B497_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class OeB497Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_B497_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeB497Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeB497Housekeeping.
  /// </summary>
  public OeB497Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    export.ProgramProcessingInfo.Name = "SWEEB497";
    ...
    local.NeededToOpen.RptHeading3 =
      "                HEALTH INSURANCE POLICIES TERMINATED" + "" + "" + "";
    ...
    local.NeededToOpen.ColHeading1 = " INSURED   CARRIER   POLICY          END";
