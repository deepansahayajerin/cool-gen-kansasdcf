...
/// <summary>
/// <para>
/// A program: OE_CAL3_CALCULATE_WKSHEET_PAGE_3.
/// </para>
/// <para>
/// Resp - OBLGESTB
/// </para>
...
public partial class OeCal3CalculateWksheetPage3: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_CAL3_CALCULATE_WKSHEET_PAGE_3 program.
  /// </summary>
  [Entry]
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeCal3CalculateWksheetPage3(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeCal3CalculateWksheetPage3.
  /// </summary>
  public OeCal3CalculateWksheetPage3(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
