...
/// <summary>
/// <para>
/// A program: OE_CALC_CALCULATE_WKSHEET_PAGE_1.
/// </para>
/// <para>
/// Resp - OBLGESTB
/// </para>
...
public partial class OeCalcCalculateWksheetPage1: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_CALC_CALCULATE_WKSHEET_PAGE_1 program.
  /// </summary>
  [Entry]
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeCalcCalculateWksheetPage1(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeCalcCalculateWksheetPage1.
  /// </summary>
  public OeCalcCalculateWksheetPage1(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // 04/04/95  Sid           Initial Creation
    // 06/26/96  R. Welborn    Add Left Pad EAB
    // ---------------------------------------------
    // ---------------------------------------------
    ...
    // ---------------------------------------------
    // Check for first time the screen is entered.
