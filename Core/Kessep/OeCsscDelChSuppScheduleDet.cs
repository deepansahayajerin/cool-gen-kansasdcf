// Program: OE_CSSC_DEL_CH_SUPP_SCHEDULE_DET, ID: 371909262, model: 746.
// Short name: SWE00896
using System;
...
/// <summary>
/// <para>
/// A program: OE_CSSC_DEL_CH_SUPP_SCHEDULE_DET.
/// </para>
/// <para>
/// RESP: OBLGESTB
/// WRITTEN BY:SID
...
/// </summary>
[Serializable]
public partial class OeCsscDelChSuppScheduleDet: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the OE_CSSC_DEL_CH_SUPP_SCHEDULE_DET program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new OeCsscDelChSuppScheduleDet(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of OeCsscDelChSuppScheduleDet.
  /// </summary>
  public OeCsscDelChSuppScheduleDet(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    if (ReadAgeGroupSupportSchedule2())
    {
      ...
      {
        DeleteCsGrossMonthlyIncSched2();
        ExitState = "ACO_NI0000_SUCCESSFUL_DELETE";
      }
    }
  }

  private void DeleteCsGrossMonthlyIncSched1()
  {
    Update("DeleteCsGrossMonthlyIncSched1",
      (db, command) =>
      {
        db.SetInt32(
  ...
  private void DeleteCsGrossMonthlyIncSched2()
  {
    Update("DeleteCsGrossMonthlyIncSched2",
      (db, command) =>
      {
        db.SetInt32(
          command, "cssIdentifier",
  ...
  private void DeleteCsGrossMonthlyIncSched3()
  {
    Update("DeleteCsGrossMonthlyIncSched3",
      (db, command) =>
      {
        db.SetInt32(
          command, "cssIdentifier",
