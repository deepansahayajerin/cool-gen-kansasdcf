// Program: SC_CAB_TEST_SECURITY, ID: 371427310, model: 746.
// Short name: SWE01082
using System;
...
/// <summary>
/// <para>
/// A program: SC_CAB_TEST_SECURITY.
/// </para>
/// <para>
...
/// </summary>
[Serializable]
public partial class ScCabTestSecurity: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SC_CAB_TEST_SECURITY program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new ScCabTestSecurity(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of ScCabTestSecurity.
  /// </summary>
  public ScCabTestSecurity(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // 02/21/01 - K. Doshi - Performance change.
    // -------------------------------------------------------------------
    // ----------------------------------------------------------------------------------
