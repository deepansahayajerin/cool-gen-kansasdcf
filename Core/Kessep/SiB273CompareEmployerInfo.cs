// Program: SI_B273_COMPARE_EMPLOYER_INFO, ID: 371058716, model: 746.
// Short name: SWE01275
using System;
...
/// <summary>
/// A program: SI_B273_COMPARE_EMPLOYER_INFO.
/// </summary>
[Serializable]
public partial class SiB273CompareEmployerInfo: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_B273_COMPARE_EMPLOYER_INFO program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiB273CompareEmployerInfo(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiB273CompareEmployerInfo.
  /// </summary>
  public SiB273CompareEmployerInfo(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
