// Program: SI_B273_HOUSEKEEPING, ID: 371059788, model: 746.
// Short name: SWE01272
using System;
...
/// <summary>
/// A program: SI_B273_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class SiB273Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_B273_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiB273Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiB273Housekeeping.
  /// </summary>
  public SiB273Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // **********************************************************
    local.ProgramProcessingInfo.Name = "SWEIB273";
    ...
    if (ReadProgramProcessingInfo())
    {
      ...
      {
        export.AlreadyProcessRpt.Flag = "Y";
      }
    }
    ...
    // **********************************************************
    local.NeededToOpen.RptHeading3 =
      "                  FEDERAL NEW HIRE NAME MISMATCH";
    local.NeededToOpen.NumberOfColHeadings = 2;
    local.NeededToOpen.ColHeading1 =
    ...
    // **********************************************************
    local.NeededToOpen.RptHeading3 =
      "FEDERAL NEW HIRE EMPLOYER NAME OR ADDRESS MISMATCH";
    local.NeededToOpen.NumberOfColHeadings = 2;
    local.NeededToOpen.ColHeading1 =
    ...
    // **********************************************************
    // OPEN OUTPUT REPORT 05 - ALREADY PROCESSED EMPLOYEMNT RECORDS
    // **********************************************************
    local.NeededToOpen.RptHeading3 =
      "        FEDERAL NEW HIRE - ALREADY PROCESSED EMPLOYMENT";
    local.NeededToOpen.NumberOfColHeadings = 2;
    local.NeededToOpen.ColHeading1 = " Field   Information";
    local.NeededToOpen.ColHeading2 =
      "-------- --------------------------------------------------------";
