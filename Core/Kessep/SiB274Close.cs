// Program: SI_B274_CLOSE, ID: 371072625, model: 746.
// Short name: SWE01283
using System;
...
/// <summary>
/// A program: SI_B274_CLOSE.
/// </summary>
[Serializable]
public partial class SiB274Close: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_B274_CLOSE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiB274Close(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiB274Close.
  /// </summary>
  public SiB274Close(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
  ...
  public void Run()
  {
    ...
    do
    {
      switch(local.Subscript.Count)
      {
        ...
        case 4:
          local.EabReportSend.RptDetail =
            "INCOME SOURCES UPDATED             " + "   " + NumberToString
            (import.NumberIncSrcUpdates.Count, 15);

          break;
        case 5:
          local.EabReportSend.RptDetail =
            "RECORDS SKIPPED - QTRLY WAGE REPORT" + "   " + NumberToString
            (import.RecordsSkippedNuhireRp.Count, 15);

          break;
        case 6:
          local.EabReportSend.RptDetail =
            "RECORDS SKIPPED - UNKNOWN          " + "   " + NumberToString
        ...
        case 12:
          local.TotalProcessed.Count = import.IncomeSourcesCreated.Count + import
            .NumberIncSrcUpdates.Count + import.RecordsSkippedNuhireRp.Count + import
