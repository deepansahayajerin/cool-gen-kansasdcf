// Program: SI_B275_HOUSEKEEPING, ID: 372745441, model: 746.
// Short name: SWE02571
using System;
...
/// <summary>
/// A program: SI_B275_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class SiB275Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_B275_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiB275Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiB275Housekeeping.
  /// </summary>
  public SiB275Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // **********************************************************
    local.ProgramProcessingInfo.Name = "SWEIB275";
    ...
    // **********************************************************
    // OPEN OUTPUT NEW HIRE QUERY FILE TO BE SENT TO DHR
    // **********************************************************
