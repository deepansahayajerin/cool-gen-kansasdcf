// Program: SI_B290_HOUSEKEEPING, ID: 372811932, model: 746.
// Short name: SWE02475
using System;
...
/// <summary>
/// A program: SI_B290_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class SiB290Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_B290_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiB290Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiB290Housekeeping.
  /// </summary>
  public SiB290Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // ----------------------------------------------------------------------
    local.ProgramProcessingInfo.Name = "SWEIB290";
    ...
    if (AsChar(export.ProgramCheckpointRestart.RestartInd) == 'Y')
    {
      ...
      // ----------------------------------------------------------------------
      export.Restart.TransSerialNumber =
        StringToNumber(Substring(
          export.ProgramCheckpointRestart.RestartInfo, 250, 1, 15));
      export.RestartFileRecord.Count =
        (int)StringToNumber(Substring(
          export.ProgramCheckpointRestart.RestartInfo, 250, 16, 15));
    }
    ...
    local.EabReportSend.RptDetail =
      "Error                                                       Trans #        Date      Case #      Office  OSP";
...
#region Structures
  ...
  public class Export
  {
    ...
    /// <summary>
    /// A value of RestartFileRecord.
    /// </summary>
    [JsonPropertyName("restartFileRecord")]
    public Common RestartFileRecord
    {
      get => restartFileRecord ??= new();
      set => restartFileRecord = value;
    }
    ...
    private Common restartFileRecord;
