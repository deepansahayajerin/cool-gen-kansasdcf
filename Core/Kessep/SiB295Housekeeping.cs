// Program: SI_B295_HOUSEKEEPING, ID: 372763795, model: 746.
// Short name: SWE02468
using System;
...
/// <summary>
/// A program: SI_B295_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class SiB295Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_B295_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiB295Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiB295Housekeeping.
  /// </summary>
  public SiB295Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // ----------------------------------------------------------------------
    local.ProgramProcessingInfo.Name = "SWEIB295";
    ...
    if (AsChar(export.ProgramCheckpointRestart.RestartInd) == 'Y')
    {
      ...
      // ----------------------------------------------------------------------
      export.RestartRecord.Count =
        (int)StringToNumber(Substring(
          export.ProgramCheckpointRestart.RestartInfo, 250, 7, 9));
    }
