// Program: SI_B462_HOUSEKEEPING, ID: 371161525, model: 746.
// Short name: SWE03621
using System;
...
/// <summary>
/// A program: SI_B462_HOUSEKEEPING.
/// </summary>
[Serializable]
public partial class SiB462Housekeeping: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_B462_HOUSEKEEPING program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiB462Housekeeping(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiB462Housekeeping.
  /// </summary>
  public SiB462Housekeeping(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // ***********************************************
    local.ProgramProcessingInfo.Name = "SWEIB462";
