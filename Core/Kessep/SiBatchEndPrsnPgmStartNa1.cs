// Program: SI_BATCH_END_PRSN_PGM_START_NA_1, ID: 373296496, model: 746.
// Short name: SWE01554
using System;
...
/// <summary>
/// A program: SI_BATCH_END_PRSN_PGM_START_NA_1.
/// </summary>
[Serializable]
public partial class SiBatchEndPrsnPgmStartNa1: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_BATCH_END_PRSN_PGM_START_NA_1 program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiBatchEndPrsnPgmStartNa1(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiBatchEndPrsnPgmStartNa1.
  /// </summary>
  public SiBatchEndPrsnPgmStartNa1(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // *******************************************************
    // As a part of PR # 00115534  we change the read to person 
    // program_discontinue date  >=  import interface_person program
    // prog_effective_date
    // earlier it was
    // person  program_discontinue date being equal to max date .
