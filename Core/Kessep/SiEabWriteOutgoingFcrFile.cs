// Program: SI_EAB_WRITE_OUTGOING_FCR_FILE, ID: 371419349, model: 746.
// Short name: SWEXEW09
using System;
...
/// <summary>
/// <para>
/// A program: SI_EAB_WRITE_OUTGOING_FCR_FILE.
/// </para>
/// <para>
/// Resp:OBLGEST
...
/// </summary>
[Serializable]
public partial class SiEabWriteOutgoingFcrFile: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_EAB_WRITE_OUTGOING_FCR_FILE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiEabWriteOutgoingFcrFile(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiEabWriteOutgoingFcrFile.
  /// </summary>
  public SiEabWriteOutgoingFcrFile(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  public void Run()
  {
    GetService<IEabStub>().Execute(
      "SWEXEW09", context, import, export, EabOptions.Hpvp);
  }
#endregion
...
#region Structures
  ...
  public class Import
  {
    ...
    [Member(Index = 6, Members = new[] { "FileInstruction" })]
