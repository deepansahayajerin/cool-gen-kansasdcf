// Program: SI_GET_APS_FOR_CASE, ID: 1902634393, model: 746.
// Short name: SWE01244
using System;
...
/// <summary>
/// A program: SI_GET_APS_FOR_CASE.
/// </summary>
[Serializable]
public partial class SiGetApsForCase: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_GET_APS_FOR_CASE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiGetApsForCase(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiGetApsForCase.
  /// </summary>
  public SiGetApsForCase(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // 01-08-2018   D.Dupree        Initial Development.
    // -------------------------------------------------------------------
    // -------------------------------------------------------------------
    // The purpose of this CAB is to READ EACH
    // of all AP(s) on the import Case
