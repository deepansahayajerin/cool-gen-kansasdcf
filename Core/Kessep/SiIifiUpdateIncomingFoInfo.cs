// Program: SI_IIFI_UPDATE_INCOMING_FO_INFO, ID: 372500273, model: 746.
// Short name: SWE01662
using System;
...
/// <summary>
/// <para>
/// A program: SI_IIFI_UPDATE_INCOMING_FO_INFO.
/// </para>
/// <para>
/// ACTION BLOCK THAT ALLOWS FOR UPDATING OF TH INTERNET ADDRESS FIELD ON 
/// FOREIGN INFORMATION RECORDS.
/// </para>
/// </summary>
[Serializable]
public partial class SiIifiUpdateIncomingFoInfo: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_IIFI_UPDATE_INCOMING_FO_INFO program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiIifiUpdateIncomingFoInfo(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiIifiUpdateIncomingFoInfo.
  /// </summary>
  public SiIifiUpdateIncomingFoInfo(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
...
#region Implementation
  ...
  {
    // -----------------------------------------------------------
    // 04/13/99    Scroggins         Initial Development
    // -----------------------------------------------------------
