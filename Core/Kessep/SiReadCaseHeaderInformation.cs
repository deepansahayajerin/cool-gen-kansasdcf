// Program: SI_READ_CASE_HEADER_INFORMATION, ID: 371731790, model: 746.
// Short name: SWE01202
using System;
...
/// <summary>
/// <para>
/// A program: SI_READ_CASE_HEADER_INFORMATION.
/// </para>
/// <para>
/// RESP: SRVINIT		
...
/// </summary>
[Serializable]
public partial class SiReadCaseHeaderInformation: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_READ_CASE_HEADER_INFORMATION program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiReadCaseHeaderInformation(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiReadCaseHeaderInformation.
  /// </summary>
  public SiReadCaseHeaderInformation(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
  ...
  public void Run()
  {
    ...
    if (AsChar(export.CaseOpen.Flag) == 'Y')
    {
      if (IsEmpty(import.Ap.Number))
      {
        ...
        foreach(var item in ReadCsePersonCaseRole8())
        {
          ++local.Common.Count;
        }
...
Test2:
  ...
  private IEnumerable<bool> ReadCsePersonCaseRole8()
  {
    entities.CsePerson.Populated = false;
    entities.CaseRole.Populated = false;

    return ReadEach("ReadCsePersonCaseRole8",
      (db, command) =>
      {
        db.SetNullableDate(
          command, "startDate", local.Current.Date.GetValueOrDefault());
