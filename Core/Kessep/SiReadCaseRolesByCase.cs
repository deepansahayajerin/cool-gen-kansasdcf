// Program: SI_READ_CASE_ROLES_BY_CASE, ID: 371785559, model: 746.
// Short name: SWE01204
using System;
...
/// <summary>
/// <para>
/// A program: SI_READ_CASE_ROLES_BY_CASE.
/// </para>
/// <para>
/// RESP: SRVINIT		
...
/// </summary>
[Serializable]
public partial class SiReadCaseRolesByCase: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_READ_CASE_ROLES_BY_CASE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiReadCaseRolesByCase(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiReadCaseRolesByCase.
  /// </summary>
  public SiReadCaseRolesByCase(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // 08-23-95  Helen S - MTW         0      Initial Development
    // ----------------------------------------------------------
    // 05-11-99  Marek L        Improve READ EACH,
    //                          added  Start_DATE to the
    //                          IMPORT_PAGE_KEY CASE_ROLE
    //                          Entity  View.
    // ---------------------------------------------------------
    // 06/28/99 M.Lachowicz  Change property of READ
    ...
    // 05/11/99 Marek Lachowicz
    // Improve READ EACH adding new clauses
    foreach(var item in ReadCaseRoleCsePerson())
    {
      ...
      {
        export.PageKeyCaseRole.EndDate = entities.CaseRole.EndDate;

        // Marek L.
        // Pass Start_Date to calling Prad.
        export.PageKeyCaseRole.StartDate = entities.CaseRole.StartDate;
        export.PageKeyCsePerson.Number = entities.CsePerson.Number;

        break;
      }

      export.Export1.Update.DetailCsePerson.Number = entities.CsePerson.Number;
    ...
    // 05/11/99   Marek L.             Start of disabled code.
    // 05/11/99   Marek L.             End of disabled code.
    // ---------------------------------------------
  ...
  private IEnumerable<bool> ReadCaseRoleCsePerson()
  {
    ...
    return ReadEach("ReadCaseRoleCsePerson",
      (db, command) =>
      {
        ...
        db.SetNullableDate(
          command, "startDate",
          import.PageKeyCaseRole.StartDate.GetValueOrDefault());
