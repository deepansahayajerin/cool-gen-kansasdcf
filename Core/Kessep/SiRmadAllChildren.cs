// Program: SI_RMAD_ALL_CHILDREN, ID: 373475607, model: 746.
// Short name: SWE00661
using System;
...
/// <summary>
/// A program: SI_RMAD_ALL_CHILDREN.
/// </summary>
[Serializable]
public partial class SiRmadAllChildren: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_RMAD_ALL_CHILDREN program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiRmadAllChildren(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiRmadAllChildren.
  /// </summary>
  public SiRmadAllChildren(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
