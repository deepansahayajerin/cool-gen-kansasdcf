// Program: SI_RMAD_CREATE_CASE_ROLE, ID: 373476820, model: 746.
// Short name: SWE01352
using System;
...
/// <summary>
/// <para>
/// A program: SI_RMAD_CREATE_CASE_ROLE.
/// </para>
/// <para>
/// RESP: SRVINIT	
...
/// </summary>
[Serializable]
public partial class SiRmadCreateCaseRole: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_RMAD_CREATE_CASE_ROLE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiRmadCreateCaseRole(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiRmadCreateCaseRole.
  /// </summary>
  public SiRmadCreateCaseRole(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // --------------------------------------------------------------------------------
    // Date &
    // Reference      Developer Name 	     Description
    // ----------     --------------------  
    // -------------------------------------------
    // 11/04/2009     Raj S     	     Modified to fix CA:GEN V76 upgrade 
    // probolem
    // CQ13735
    // 
    // of Null indicator by
