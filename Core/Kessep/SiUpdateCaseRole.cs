// Program: SI_UPDATE_CASE_ROLE, ID: 371755710, model: 746.
// Short name: SWE01245
using System;
...
/// </summary>
[Serializable]
public partial class SiUpdateCaseRole: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SI_UPDATE_CASE_ROLE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SiUpdateCaseRole(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SiUpdateCaseRole.
  /// </summary>
  public SiUpdateCaseRole(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  private IEnumerable<bool> ReadCsePersonCaseRole2()
  {
    ...
    return ReadEach("ReadCsePersonCaseRole2",
      ...
      (db, reader) =>
      {
        ...
        entities.ArCaseRole.CasNumber = db.GetString(reader, 1);
        entities.ArCaseRole.Type1 = db.GetString(reader, 2);
        entities.ArCaseRole.Identifier = db.GetInt32(reader, 3);
        entities.ArCaseRole.Note = db.GetNullableString(reader, 4);
  ...
  private void UpdateCaseRole4()
  {
    ...
    var lastUpdatedTimestamp = Now();
    var lastUpdatedBy = global.UserId;
    var arChgProcReqInd = import.CaseRole.ArChgProcReqInd ?? "";
    var arChgProcessedDate = entities.CaseRole.ArChgProcessedDate;
    var arInvalidInd = import.CaseRole.ArInvalidInd ?? "";
  ...
  private void UpdateCaseRole7()
  {
    ...
    entities.ArCaseRole.Note = note;
    entities.ArCaseRole.Populated = true;
  }

  private void UpdateCaseRole8()
  {
