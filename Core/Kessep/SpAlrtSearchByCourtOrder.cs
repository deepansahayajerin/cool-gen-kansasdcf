// Program: SP_ALRT_SEARCH_BY_COURT_ORDER, ID: 1902640513, model: 746.
// Short name: SWE01346
using System;
...
/// <summary>
/// A program: SP_ALRT_SEARCH_BY_COURT_ORDER.
/// </summary>
[Serializable]
public partial class SpAlrtSearchByCourtOrder: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_ALRT_SEARCH_BY_COURT_ORDER program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpAlrtSearchByCourtOrder(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpAlrtSearchByCourtOrder.
  /// </summary>
  public SpAlrtSearchByCourtOrder(IContext context, Import import, Export export)
    :
    base(context)
  {
    this.import = import;
        ...
        foreach(var item in ReadInfrastructureOfficeServiceProviderAlert3())
        {
          ...
          switch(TrimEnd(entities.OfficeServiceProviderAlert.TypeCode))
          {
            case "AUT":
              ...
              {
                local.La.CourtCaseNumber = entities.LegalAction.CourtCaseNumber;
              }
              else
              {
                continue;
                ...
                switch(Length(TrimEnd(local.Fips.Text4)))
                {
                  ...
                  case 4:
                    ...
                    if (!IsEmpty(import.FilterFips.StateAbbreviation) && Equal
                      (import.FilterFips.StateAbbreviation, local.Fips.Text4, 1,
                      2) && !IsEmpty(import.FilterFips.CountyAbbreviation) && Equal
                    ...
                    break;
                  default:
                    // --There are an unrecognizable number of characters.  Skip
                    // the alert.
    ...
    return ReadEach("ReadInfrastructureOfficeServiceProviderAlert1",
      (db, command) =>
      {
        db.SetNullableString(
          command, "denormText12", local.Filter.DenormText12 ?? "");
        db.SetDate(
