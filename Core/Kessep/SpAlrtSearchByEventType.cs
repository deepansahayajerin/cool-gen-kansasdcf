// Program: SP_ALRT_SEARCH_BY_EVENT_TYPE, ID: 1902640515, model: 746.
// Short name: SWE01345
using System;
...
/// <summary>
/// A program: SP_ALRT_SEARCH_BY_EVENT_TYPE.
/// </summary>
[Serializable]
public partial class SpAlrtSearchByEventType: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_ALRT_SEARCH_BY_EVENT_TYPE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpAlrtSearchByEventType(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpAlrtSearchByEventType.
  /// </summary>
  public SpAlrtSearchByEventType(IContext context, Import import, Export export):
...
#region Implementation
        ...
        foreach(var item in ReadInfrastructureOfficeServiceProviderAlert3())
        {
          ...
          if (!IsEmpty(import.FilterInfrastructure.CaseNumber))
          {
            if (!Equal(entities.Infrastructure.CaseNumber,
              import.FilterInfrastructure.CaseNumber))
            {
              continue;
            }
          }
  ...
  private IEnumerable<bool> ReadInfrastructureOfficeServiceProviderAlert1()
  {
    ...
    return ReadEach("ReadInfrastructureOfficeServiceProviderAlert1",
      (db, command) =>
      {
        db.SetString(command, "eventType", local.Filter.EventType);
        db.SetDate(
