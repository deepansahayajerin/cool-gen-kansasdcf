// Program: SP_ALRT_SEARCH_BY_OFFICE, ID: 1902640514, model: 746.
// Short name: SWE01343
using System;
...
/// <summary>
/// A program: SP_ALRT_SEARCH_BY_OFFICE.
/// </summary>
[Serializable]
public partial class SpAlrtSearchByOffice: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_ALRT_SEARCH_BY_OFFICE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpAlrtSearchByOffice(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpAlrtSearchByOffice.
  /// </summary>
  public SpAlrtSearchByOffice(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
      ...
      (db, command) =>
      {
        db.SetDate(
          ...
          import.FilterOfficeServiceProviderAlert.DistributionDate.
            GetValueOrDefault());
        db.SetNullableInt32(
          command, "offId", import.FilterOffice.SystemGeneratedId);
        db.SetString(
          command, "typeCode",
