// Program: SP_ALRT_SEARCH_BY_PERSON, ID: 1902640512, model: 746.
// Short name: SWE01342
using System;
...
/// <summary>
/// A program: SP_ALRT_SEARCH_BY_PERSON.
/// </summary>
[Serializable]
public partial class SpAlrtSearchByPerson: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_ALRT_SEARCH_BY_PERSON program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpAlrtSearchByPerson(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpAlrtSearchByPerson.
  /// </summary>
  public SpAlrtSearchByPerson(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
