// Program: SP_B709_WRITE_CONTROLS_AND_CLOSE, ID: 372132410, model: 746.
// Short name: SWE02286
using System;
...
/// <summary>
/// A program: SP_B709_WRITE_CONTROLS_AND_CLOSE.
/// </summary>
[Serializable]
public partial class SpB709WriteControlsAndClose: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_B709_WRITE_CONTROLS_AND_CLOSE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpB709WriteControlsAndClose(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpB709WriteControlsAndClose.
  /// </summary>
  public SpB709WriteControlsAndClose(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
      ...
      ; ++local.Subscript.Count)
    {
      ...
      switch(local.Subscript.Count)
      {
        ...
        case 7:
          ...
          break;
        case 8:
          local.Label.Text40 = "DOCUMENTS CANCELLED";
          local.EabConvertNumeric.SendAmount =
            NumberToString(import.DocsCancelled.Count, 15);
        ...
        case 10:
          ...
          local.EabReportSend.RptDetail = local.Label.Text20 + "         READ    PROCESSED       FUTURE    EXCEPTION   DATA ERROR SYSTEM ERROR      WARNING    CANCELLED";
      ...
      else if (!IsEmpty(local.Document.Name))
      {
        ...
        UseEabConvertNumeric1();
        local.EabReportSend.RptDetail = local.Label.Text20 + Substring
          (local.EabConvertNumeric.ReturnNoCommasInNonDecimal,
          EabConvertNumeric2.ReturnNoCommasInNonDecimal_MaxLength, 3, 14);
        local.EabConvertNumeric.SendAmount =
        ...
        local.EabReportSend.RptDetail =
          ...
          EabConvertNumeric2.ReturnNoCommasInNonDecimal_MaxLength, 3, 14);
        local.EabConvertNumeric.SendAmount =
          NumberToString(import.DocumentTotals.Item.GimportCancelled.Count, 15);
...
#region Structures
  ...
  public class Import
  {
    ...
    public class DocumentTotalsGroup
    {
      ...
      /// <summary>
      /// A value of GimportCancelled.
      /// </summary>
      [JsonPropertyName("gimportCancelled")]
      public Common GimportCancelled
      {
        get => gimportCancelled ??= new();
        set => gimportCancelled = value;
      }
      ...
      private Common gimportCancelled;
    }
