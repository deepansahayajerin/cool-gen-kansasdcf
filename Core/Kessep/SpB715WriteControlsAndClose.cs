// Program: SP_B715_WRITE_CONTROLS_AND_CLOSE, ID: 371339565, model: 746.
// Short name: SWE02240
using System;
...
/// <summary>
/// A program: SP_B715_WRITE_CONTROLS_AND_CLOSE.
/// </summary>
[Serializable]
public partial class SpB715WriteControlsAndClose: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_B715_WRITE_CONTROLS_AND_CLOSE program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpB715WriteControlsAndClose(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpB715WriteControlsAndClose.
  /// </summary>
  public SpB715WriteControlsAndClose(IContext context, Import import,
    Export export):
    base(context)
  {
    this.import = import;
        ...
        ; ++local.Subscript.Count)
      {
        ...
        else if (!IsEmpty(local.Document.Name))
        {
          ...
          local.EabReportSend.RptDetail =
            ...
            .EabConvertNumeric.ReturnNoCommasInNonDecimal;
          local.EabConvertNumeric.SendAmount =
            NumberToString(import.DocumentTotals.Item.GimportSystemError.Count,
            15);
          UseEabConvertNumeric1();
          local.EabReportSend.RptDetail =
            TrimEnd(local.EabReportSend.RptDetail) + local
