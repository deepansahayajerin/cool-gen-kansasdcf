// Program: SP_CAB_GLOBAL_REASSIGN_ADA, ID: 372783717, model: 746.
// Short name: SWE02204
using System;
...
/// <summary>
/// A program: SP_CAB_GLOBAL_REASSIGN_ADA.
/// </summary>
[Serializable]
public partial class SpCabGlobalReassignAda: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_CAB_GLOBAL_REASSIGN_ADA program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpCabGlobalReassignAda(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpCabGlobalReassignAda.
  /// </summary>
  public SpCabGlobalReassignAda(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // check for
    //                                 
    // MAX date on the Administrative
    // Appeal Assignment and
    //                                 
    // Monitored Activity Assignment
    // reads
    // -------------------------------------------------------------------
    // 06/13/2010   CQ20565  swdpjlh   Performance change.
    // ------------------------------------------------------------------------
    ...
    foreach(var item in ReadAdministrativeAppealAssignment())
    {
      if (AsChar(entities.GlobalReassignment.OverrideFlag) == 'Y')
      {
      }
      else if (AsChar(entities.ExistingAdministrativeAppealAssignment.
        OverrideInd) == 'Y')
      {
        continue;
      }
      ...
      {
        // Since no updates have occurred for this occurrence of Administrative 
        // Appeal Assignment,
        // create a local error group program error occurrence then go get the 
        // next Administrative Appeal Assignment. A rollback is not needed.
        export.SoftError.Flag = "Y";

        ++export.Error.Index;
        export.Error.CheckSize();

        export.Error.Update.Detail.Code = "ADANF";
        export.Error.Update.Detail.ProgramError1 =
          "Administrative Appeal not found.  Database error.";
        ...
        export.Error.Update.Detail.KeyInfo =
          ...
          (entities.ExistingServiceProvider.SystemGeneratedId, 11, 5) + " Administrative Appeal not found.  Database error.";
    ...
    if (export.BusObjCount.Count > 0)
    {
      ...
      local.Infrastructure.ReasonCode = "ADAXFR";
      local.Infrastructure.ReferenceDate = local.Current.Date;
      local.Infrastructure.Detail =
        "ADA business object transferred via the GBOR batch process.";
      ...
      else
      {
        ...
        export.Error.Update.Detail.Code = "ADAINFNC";
        export.Error.Update.Detail.KeyInfo = "Office: " + NumberToString
          (entities.ExistingOffice.SystemGeneratedId, 12, 4) + " OSP:";
        export.Error.Update.Detail.KeyInfo =
          TrimEnd(export.Error.Item.Detail.KeyInfo) + " " + NumberToString
      ...
      local.OfficeServiceProviderAlert.Description =
        "'ADA' business object and associated Monitored Activities have been transferred to another SP";
        
      local.OfficeServiceProviderAlert.Description =
        "This alert informs OSP's that " + entities
        .GlobalReassignment.BusinessObjectCode;
      local.OfficeServiceProviderAlert.Description =
        TrimEnd(local.OfficeServiceProviderAlert.Description) + " business objects have been unassigned from them or reassigned to them via Global Reassigment batch processing.";
      ...
      local.OfficeServiceProviderAlert.Message =
        ...
        .HoldSpNum.Text15;
      local.OfficeServiceProviderAlert.Message =
        TrimEnd(local.OfficeServiceProviderAlert.Message) + " Ofc:";
      local.OfficeServiceProviderAlert.Message =
        TrimEnd(local.OfficeServiceProviderAlert.Message) + "/";
      local.OfficeServiceProviderAlert.Message =
        TrimEnd(local.OfficeServiceProviderAlert.Message) + local
      ...
      local.OfficeServiceProviderAlert.Description =
        "'ADA' business object and associated Monitored Activities have been transferred from another SP";
      ...
      local.OfficeServiceProviderAlert.Message =
        ...
        .GlobalReassignment.AssignmentReasonCode;
      local.OfficeServiceProviderAlert.Message =
        TrimEnd(local.OfficeServiceProviderAlert.Message) + " rsgd frm SP:";
      local.OfficeServiceProviderAlert.Message =
        TrimEnd(local.OfficeServiceProviderAlert.Message) + local
        .HoldSpNum.Text15;
      local.OfficeServiceProviderAlert.Message =
      ...
      local.OfficeServiceProviderAlert.Message =
        ...
        .HoldOffcNum.Text15;
      local.OfficeServiceProviderAlert.Message =
        TrimEnd(local.OfficeServiceProviderAlert.Message) + " to SP:";
      local.HoldSpNum.Text15 =
        NumberToString(entities.NewServiceProvider.SystemGeneratedId, 15);
      local.HoldSpNum.Text15 = Substring(local.HoldSpNum.Text15, 11, 5);
      local.HoldOffcNum.Text15 =
  ...
  private void CreateAdministrativeAppealAssignment()
  {
    ...
    var overrideInd =
      entities.ExistingAdministrativeAppealAssignment.OverrideInd;
    ...
    entities.NewAdministrativeAppealAssignment.Populated = false;
    ...
    entities.NewAdministrativeAppealAssignment.ReasonCode = reasonCode;
    entities.NewAdministrativeAppealAssignment.OverrideInd = overrideInd;
    entities.NewAdministrativeAppealAssignment.EffectiveDate = effectiveDate;
    entities.NewAdministrativeAppealAssignment.DiscontinueDate =
      discontinueDate;
    entities.NewAdministrativeAppealAssignment.CreatedBy = createdBy;
    entities.NewAdministrativeAppealAssignment.CreatedTimestamp =
      createdTimestamp;
    entities.NewAdministrativeAppealAssignment.LastUpdatedBy = "";
    entities.NewAdministrativeAppealAssignment.LastUpdatedTimestamp = null;
    entities.NewAdministrativeAppealAssignment.SpdId = spdId;
    entities.NewAdministrativeAppealAssignment.OffId = offId;
    entities.NewAdministrativeAppealAssignment.OspCode = ospCode;
    entities.NewAdministrativeAppealAssignment.OspDate = ospDate;
    entities.NewAdministrativeAppealAssignment.AapId = aapId;
    entities.NewAdministrativeAppealAssignment.Populated = true;
  }
  ...
  private bool ReadAdministrativeAppeal()
  {
    System.Diagnostics.Debug.Assert(
      entities.ExistingAdministrativeAppealAssignment.Populated);
    ...
    return Read("ReadAdministrativeAppeal",
      ...
      {
        db.SetInt32(
          command, "adminAppealId",
          entities.ExistingAdministrativeAppealAssignment.AapId);
      },
      (db, reader) =>
      {
  ...
  private IEnumerable<bool> ReadAdministrativeAppealAssignment()
  {
    System.Diagnostics.Debug.Assert(
      entities.ExistingOfficeServiceProvider.Populated);
    entities.ExistingAdministrativeAppealAssignment.Populated = false;

    return ReadEach("ReadAdministrativeAppealAssignment",
      (db, command) =>
      {
        db.SetDate(
          command, "ospDate",
      ...
      (db, reader) =>
      {
        entities.ExistingAdministrativeAppealAssignment.ReasonCode =
          db.GetString(reader, 0);
        entities.ExistingAdministrativeAppealAssignment.OverrideInd =
          db.GetString(reader, 1);
        entities.ExistingAdministrativeAppealAssignment.EffectiveDate =
          db.GetDate(reader, 2);
        entities.ExistingAdministrativeAppealAssignment.DiscontinueDate =
          db.GetNullableDate(reader, 3);
        entities.ExistingAdministrativeAppealAssignment.CreatedBy =
          db.GetString(reader, 4);
        entities.ExistingAdministrativeAppealAssignment.CreatedTimestamp =
          db.GetDateTime(reader, 5);
        entities.ExistingAdministrativeAppealAssignment.LastUpdatedBy =
          db.GetNullableString(reader, 6);
        entities.ExistingAdministrativeAppealAssignment.LastUpdatedTimestamp =
          db.GetNullableDateTime(reader, 7);
        entities.ExistingAdministrativeAppealAssignment.SpdId =
          db.GetInt32(reader, 8);
        entities.ExistingAdministrativeAppealAssignment.OffId =
          db.GetInt32(reader, 9);
        entities.ExistingAdministrativeAppealAssignment.OspCode =
          db.GetString(reader, 10);
        entities.ExistingAdministrativeAppealAssignment.OspDate =
          db.GetDate(reader, 11);
        entities.ExistingAdministrativeAppealAssignment.AapId =
          db.GetInt32(reader, 12);
        entities.ExistingAdministrativeAppealAssignment.Populated = true;
    ...
    return ReadEach("ReadInfrastructureMonitoredActivity",
      (db, command) =>
      {
        db.SetString(
          ...
          entities.GlobalReassignment.BusinessObjectCode);
        db.SetInt32(
          command, "identifier", entities.AdministrativeAppeal.Identifier);
      },
      (db, reader) =>
      {
...
#region Structures
  ...
  public class Entities
  {
    ...
    /// <summary>
    /// A value of NewAdministrativeAppealAssignment.
    /// </summary>
    [JsonPropertyName("newAdministrativeAppealAssignment")]
    public AdministrativeAppealAssignment NewAdministrativeAppealAssignment
    {
      get => newAdministrativeAppealAssignment ??= new();
      set => newAdministrativeAppealAssignment = value;
    }

    /// <summary>
    /// A value of ExistingAdministrativeAppealAssignment.
    /// </summary>
    [JsonPropertyName("existingAdministrativeAppealAssignment")]
    public AdministrativeAppealAssignment ExistingAdministrativeAppealAssignment
    {
      get => existingAdministrativeAppealAssignment ??= new();
      set => existingAdministrativeAppealAssignment = value;
    }
    ...
    private AdministrativeAppealAssignment newAdministrativeAppealAssignment;
    private AdministrativeAppealAssignment existingAdministrativeAppealAssignment;
