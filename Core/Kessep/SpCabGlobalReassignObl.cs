// Program: SP_CAB_GLOBAL_REASSIGN_OBL, ID: 372783719, model: 746.
// Short name: SWE02201
using System;
...
/// <summary>
/// A program: SP_CAB_GLOBAL_REASSIGN_OBL.
/// </summary>
[Serializable]
public partial class SpCabGlobalReassignObl: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_CAB_GLOBAL_REASSIGN_OBL program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpCabGlobalReassignObl(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpCabGlobalReassignObl.
  /// </summary>
  public SpCabGlobalReassignObl(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    // check for
    //                                 
    // MAX date on the Obligation
    // Assignment and
    //                                 
    // Monitored Activity Assignment
    // reads
    // -------------------------------------------------------------------
    // 06/13/2010  SWDPJLH  CQ20565  Performance change.
    // ------------------------------------------------------------------------------
    ...
    foreach(var item in ReadObligationAssignment())
    {
      ...
      else if (AsChar(entities.ExistingObligationAssignment.OverrideInd) == 'Y')
      {
        continue;
      }
      ...
      if (!ReadObligation())
      {
        ...
        export.Error.Update.Detail.Code = "OBLNF";
        export.Error.Update.Detail.ProgramError1 = "Obligation not found.";
        ...
        export.Error.Update.Detail.KeyInfo =
          ...
          (entities.ExistingServiceProvider.SystemGeneratedId, 11, 5) + " Obligation not found.";
    ...
    if (export.BusObjCount.Count > 0)
    {
      ...
      local.Infrastructure.ReasonCode = "OBLXFR";
      local.Infrastructure.ReferenceDate = local.Current.Date;
      local.Infrastructure.Detail =
        "OBL business object transferred via the GBOR batch process.";
      ...
      else
      {
        ...
        export.Error.Update.Detail.Code = "OBLINFNC";
        export.Error.Update.Detail.KeyInfo = "Office: " + NumberToString
          (entities.ExistingOffice.SystemGeneratedId, 12, 4) + " OSP:";
        export.Error.Update.Detail.KeyInfo =
          TrimEnd(export.Error.Item.Detail.KeyInfo) + " " + NumberToString
      ...
      local.OfficeServiceProviderAlert.Description =
        "'OBL' business objects and associated Monitored Activities have been transferred to another SP";
      ...
      local.OfficeServiceProviderAlert.Description =
        "'OBL' business objects and associated Monitored Activities have been transferred from another SP";
  ...
  private void CreateObligationAssignment()
  {
    ...
    var overrideInd = entities.ExistingObligationAssignment.OverrideInd;
    var effectiveDate = AddDays(local.Current.Date, 1);
    ...
    entities.NewObligationAssignment.Populated = false;
    ...
    entities.NewObligationAssignment.ReasonCode = reasonCode;
    entities.NewObligationAssignment.OverrideInd = overrideInd;
    entities.NewObligationAssignment.EffectiveDate = effectiveDate;
    entities.NewObligationAssignment.DiscontinueDate = discontinueDate;
    entities.NewObligationAssignment.CreatedBy = createdBy;
    entities.NewObligationAssignment.CreatedTimestamp = createdTimestamp;
    entities.NewObligationAssignment.LastUpdatedBy = "";
    entities.NewObligationAssignment.LastUpdatedTimestamp = null;
    entities.NewObligationAssignment.SpdId = spdId;
    entities.NewObligationAssignment.OffId = offId;
    entities.NewObligationAssignment.OspCode = ospCode;
    entities.NewObligationAssignment.OspDate = ospDate;
    entities.NewObligationAssignment.OtyId = otyId;
    entities.NewObligationAssignment.CpaType = cpaType;
    entities.NewObligationAssignment.CspNo = cspNo;
    entities.NewObligationAssignment.ObgId = obgId;
    entities.NewObligationAssignment.Populated = true;
  }
  ...
  private IEnumerable<bool> ReadInfrastructureMonitoredActivity()
  {
    ...
    return ReadEach("ReadInfrastructureMonitoredActivity",
      (db, command) =>
      {
        ...
        db.SetNullableString(command, "cspNo", entities.Obligation.CspNumber);
        db.SetNullableString(command, "cpaType", entities.Obligation.CpaType);
        db.
          SetNullableInt32(command, "otyId", entities.Obligation.DtyGeneratedId);
      ...
      (db, reader) =>
      {
        ...
        entities.Infrastructure.OtyId = db.GetNullableInt32(reader, 23);
        entities.Infrastructure.CpaType = db.GetNullableString(reader, 24);
        entities.Infrastructure.CspNo = db.GetNullableString(reader, 25);
        entities.Infrastructure.ObgId = db.GetNullableInt32(reader, 26);
        entities.Infrastructure.Function = db.GetNullableString(reader, 27);
        entities.Infrastructure.CaseUnitState =
          db.GetNullableString(reader, 28);
        entities.Infrastructure.Detail = db.GetNullableString(reader, 29);
  ...
  {
    System.Diagnostics.Debug.Assert(
      entities.ExistingObligationAssignment.Populated);
    ...
    return Read("ReadObligation",
      ...
      {
        db.
          SetInt32(command, "obId", entities.ExistingObligationAssignment.ObgId);
          
        db.SetString(
          command, "cspNumber", entities.ExistingObligationAssignment.CspNo);
        db.SetString(
          command, "cpaType", entities.ExistingObligationAssignment.CpaType);
        db.SetInt32(
          command, "dtyGeneratedId",
          entities.ExistingObligationAssignment.OtyId);
      },
      (db, reader) =>
      {
  ...
  private IEnumerable<bool> ReadObligationAssignment()
  {
    System.Diagnostics.Debug.Assert(
      entities.ExistingOfficeServiceProvider.Populated);
    entities.ExistingObligationAssignment.Populated = false;
    ...
    return ReadEach("ReadObligationAssignment",
      ...
      (db, reader) =>
      {
        entities.ExistingObligationAssignment.ReasonCode =
          db.GetString(reader, 0);
        entities.ExistingObligationAssignment.OverrideInd =
          db.GetString(reader, 1);
        entities.ExistingObligationAssignment.EffectiveDate =
          db.GetDate(reader, 2);
        entities.ExistingObligationAssignment.DiscontinueDate =
          db.GetNullableDate(reader, 3);
        entities.ExistingObligationAssignment.CreatedBy =
          db.GetString(reader, 4);
        entities.ExistingObligationAssignment.CreatedTimestamp =
          db.GetDateTime(reader, 5);
        entities.ExistingObligationAssignment.LastUpdatedBy =
          db.GetNullableString(reader, 6);
        entities.ExistingObligationAssignment.LastUpdatedTimestamp =
          db.GetNullableDateTime(reader, 7);
        entities.ExistingObligationAssignment.SpdId = db.GetInt32(reader, 8);
        entities.ExistingObligationAssignment.OffId = db.GetInt32(reader, 9);
        entities.ExistingObligationAssignment.OspCode =
          db.GetString(reader, 10);
        entities.ExistingObligationAssignment.OspDate = db.GetDate(reader, 11);
        entities.ExistingObligationAssignment.OtyId = db.GetInt32(reader, 12);
        entities.ExistingObligationAssignment.CpaType =
          db.GetString(reader, 13);
        entities.ExistingObligationAssignment.CspNo = db.GetString(reader, 14);
        entities.ExistingObligationAssignment.ObgId = db.GetInt32(reader, 15);
        entities.ExistingObligationAssignment.Populated = true;
      ...
      (db, command) =>
      {
        ...
        db.SetDateTime(
          ...
          entities.ExistingObligationAssignment.CreatedTimestamp.
            GetValueOrDefault());
        db.SetInt32(
          command, "spdId", entities.ExistingObligationAssignment.SpdId);
        db.SetInt32(
          command, "offId", entities.ExistingObligationAssignment.OffId);
        db.SetString(
          command, "ospCode", entities.ExistingObligationAssignment.OspCode);
        db.SetDate(
          command, "ospDate",
          entities.ExistingObligationAssignment.OspDate.GetValueOrDefault());
        db.SetInt32(
          command, "otyId", entities.ExistingObligationAssignment.OtyId);
        db.SetString(
          command, "cpaType", entities.ExistingObligationAssignment.CpaType);
        db.SetString(
          command, "cspNo", entities.ExistingObligationAssignment.CspNo);
        db.SetInt32(
          command, "obgId", entities.ExistingObligationAssignment.ObgId);
      });

    entities.ExistingObligationAssignment.DiscontinueDate = discontinueDate;
    entities.ExistingObligationAssignment.LastUpdatedBy = lastUpdatedBy;
    entities.ExistingObligationAssignment.LastUpdatedTimestamp =
      lastUpdatedTimestamp;
    entities.ExistingObligationAssignment.Populated = true;
  }
...
#region Structures
  ...
  public class Entities
  {
    ...
    /// <summary>
    /// A value of NewObligationAssignment.
    /// </summary>
    [JsonPropertyName("newObligationAssignment")]
    public ObligationAssignment NewObligationAssignment
    {
      get => newObligationAssignment ??= new();
      set => newObligationAssignment = value;
    }
    ...
    private ObligationAssignment newObligationAssignment;
