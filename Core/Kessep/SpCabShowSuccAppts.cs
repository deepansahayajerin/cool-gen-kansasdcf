// Program: SP_CAB_SHOW_SUCC_APPTS, ID: 371749364, model: 746.
// Short name: SWE01709
using System;
...
/// <summary>
/// <para>
/// A program: SP_CAB_SHOW_SUCC_APPTS.
/// </para>
/// <para>
///   This cab reads the successor chain for the selected appointment.  It will 
/// display a chain of appointments starting from the selected one and ending
/// with the latest appointment.
/// </para>
/// </summary>
[Serializable]
public partial class SpCabShowSuccAppts: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_CAB_SHOW_SUCC_APPTS program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpCabShowSuccAppts(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpCabShowSuccAppts.
  /// </summary>
  public SpCabShowSuccAppts(IContext context, Import import, Export export):
    base(context)
  {
    this.import = import;
    this.export = export;
...
#region Implementation
  ...
  public void Run()
  {
    ...
    else
    {
      ...
      if (ReadAppointmentOfficeServiceProviderCsePersonCase2())
      {
