// Program: SP_DMON_READ_BY_LEGAL_ACTION, ID: 372917068, model: 746.
// Short name: SWE01803
using System;
...
/// <summary>
/// <para>
/// A program: SP_DMON_READ_BY_LEGAL_ACTION.
/// </para>
/// <para>
/// This action Diagram was created by Carl Galka. It will read monitored 
/// documents that are for  a specific Court Case .
/// </para>
/// </summary>
[Serializable]
public partial class SpDmonReadByLegalAction: Bphx.Cool.Action
{
  /// <summary>
  /// Executes the SP_DMON_READ_BY_LEGAL_ACTION program.
  /// </summary>
  public static readonly Action<IContext, Import, Export> Execute =
    (c, i, e) => new SpDmonReadByLegalAction(c, i, e).Run();

  /// <summary>
  /// Constructs an instance of SpDmonReadByLegalAction.
  /// </summary>
  public SpDmonReadByLegalAction(IContext context, Import import, Export export):
...
#region Implementation
  ...
  {
    // -----------------------------------------------------------------------------------
    // This AB reads monitored documents that are for a specific LEGAL ACTION
    // -----------------------------------------------------------------------------------
