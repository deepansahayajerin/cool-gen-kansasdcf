// The source file: LOCAL_FN_WORK_AREA, ID: 371872383, model: 746.
using System;
...
[Serializable]
public partial class LocalFnWorkArea: View, ICloneable
{
  /// <summary>Default constructor.</summary>
  public LocalFnWorkArea()
  {
  }

  /// <summary>Copy constructor.</summary>
  /// <param name="that">An instance to copy.</param>
  public LocalFnWorkArea(LocalFnWorkArea that)
  {
    Init(that);
    Assign(that);
  }
  ...
  public new LocalFnWorkArea Clone() => new(this);
  ...
  public void Assign(LocalFnWorkArea that)
  {
    base.Assign(that);
    name = that.name;
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 2, Type = MemberType.Char, Length = AddressLine2_MaxLength)]
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 3, Type = MemberType.Char, Length = AddressLine1_MaxLength)]
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 6, Type = MemberType.Char, Length = Zip5_MaxLength)]
  public string Zip5
  {
    get => zip5 ?? "";
  ...
  public const int Zip4_MaxLength = 3;
  ...
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 7, Type = MemberType.Char, Length = Zip4_MaxLength)]
  public string Zip4
  {
    get => zip4 ?? "";
  ...
  /// <summary>Length of the ZIP_3 attribute.</summary>
  public const int Zip3_MaxLength = 3;

  /// <summary>
  /// The value of the ZIP_3 attribute.
  /// </summary>
  [JsonIgnore]
  [DefaultValue("")]
  [Member(Index = 8, Type = MemberType.Char, Length = Zip3_MaxLength)]
  public string Zip3
  {
    get => zip3 ?? "";
